"builtin.module"() ({
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, constant, dso_local, global_type = !llvm.array<17 x ptr>, linkage = #llvm.linkage<external>, sym_name = "jsonbType", unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
