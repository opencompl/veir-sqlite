"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %6 = "llvm.mlir.constant"() <{value = 32 : i16}> : () -> i16
    %7 = "llvm.mlir.constant"() <{value = 0 : i16}> : () -> i16
    %8 = "llvm.mlir.constant"() <{value = 0 : i8}> : () -> i8
    %9 = "llvm.mlir.constant"() <{value = 3 : i8}> : () -> i8
    %10 = "llvm.mlir.addressof"() <{global_name = @".str.800"}> : () -> !llvm.ptr
    %11 = "llvm.mlir.addressof"() <{global_name = @".str.801"}> : () -> !llvm.ptr
    %12 = "llvm.mlir.addressof"() <{global_name = @".str.799"}> : () -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.br"(%3)[^bb4] : (i64) -> ()
  ^bb3:  // pred: ^bb4
    %19 = "llvm.add"(%21, %5) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %20 = "llvm.icmp"(%19, %18) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%20, %1, %19)[^bb6, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i32, i64) -> ()
  ^bb4(%21: i64):  // 2 preds: ^bb2, ^bb3
    %22 = "llvm.getelementptr"(%17, %3, %21) <{elem_type = !llvm.array<0 x struct<"struct.ExprList_item", (ptr, ptr, struct<"struct.anon.28", packed (i8, i16, i8)>, struct<"union.anon.29", (i32)>)>>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648, 2>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
