"builtin.module"() ({
  ...
  ^bb4:  // pred: ^bb3
    ...
    %24 = "llvm.getelementptr"(%23, %0) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb3
    ...
    %26 = "llvm.getelementptr"(%25, %1) <{elem_type = !llvm.struct<"struct.Column", (ptr, i8, i8, i8, i8, i16, i16)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb7:  // 2 preds: ^bb6, ^bb8
    ...
    "llvm.store"(%32, %10) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"()[^bb8] : () -> ()
  ^bb8:  // pred: ^bb7
    ...
    %35 = "llvm.icmp"(%34, %4) <{predicate = 1 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%35)[^bb7, ^bb9] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    "llvm.br"()[^bb10] : () -> ()
  ^bb10:  // 2 preds: ^bb5, ^bb9
    ...
    "llvm.store"(%37, %8) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"()[^bb11] : () -> ()
