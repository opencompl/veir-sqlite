"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %11 = "llvm.zext"(%10) : (i1) -> i64
    %12 = "llvm.select"(%10, %2, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
  ...
  ^bb5:  // pred: ^bb4
    ...
    %17 = "llvm.call"(%15, %16) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3StrICmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i32
