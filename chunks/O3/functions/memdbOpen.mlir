"builtin.module"() ({
  ...
  ^bb10:  // pred: ^bb9
    ...
    %88 = "llvm.add"(%87, %23) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
  ...
  ^bb12:  // pred: ^bb10
    ...
    %96 = "llvm.add"(%24, %95) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %97 = "llvm.mul"(%19, %96) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
  ...
  ^bb14:  // pred: ^bb12
    ...
    "llvm.store"(%109, %20) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    %120 = "llvm.getelementptr"(%119, %24) <{elem_type = !llvm.struct<"struct.MemStore", (i64, i64, i64, ptr, ptr, i32, i32, i32, i32, i32, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
