"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    %3 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @sqlite3_initialize, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>}> : () -> i32
    %4 = "llvm.icmp"(%3, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %5 = "llvm.icmp"(%arg0, %1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %6 = "llvm.or"(%5, %4) : (i1, i1) -> i1
    "llvm.cond_br"(%6, %2)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    %7 = "llvm.zext"(%arg0) <{nonNeg}> : (i32) -> i64
    %8 = "llvm.call"(%7) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}], callee = @sqlite3Malloc, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i64) -> !llvm.ptr
