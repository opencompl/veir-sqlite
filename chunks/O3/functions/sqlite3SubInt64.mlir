"builtin.module"() ({
  ...
  ^bb7:  // 3 preds: ^bb4, ^bb5, ^bb6
    %23 = "llvm.sub"(%10, %arg1) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.br"(%23)[^bb8] : (i64) -> ()
