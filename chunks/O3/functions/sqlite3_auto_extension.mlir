"builtin.module"() ({
  ...
  ^bb9:  // pred: ^bb8
    ...
    %39 = "llvm.mul"(%38, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
  ...
  ^bb11:  // pred: ^bb9
    ...
    "llvm.store"(%45, %5) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %46 = "llvm.load"(%9) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %47 = "llvm.load"(%5) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
