"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %27 = "llvm.getelementptr"(%5, %10, %26) <{elem_type = !llvm.array<12 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %32 = "llvm.getelementptr"(%7, %10, %31) <{elem_type = !llvm.array<12 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    "llvm.br"()[^bb3] : () -> ()
  ^bb2:  // pred: ^bb0
    %35 = "llvm.load"(%6) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    ...
    %41 = "llvm.sub"(%40, %9) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
