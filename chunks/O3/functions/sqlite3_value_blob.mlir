"builtin.module"() ({
  ...
  ^bb6:  // pred: ^bb4
    ...
    %29 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.sqlite3_value", (struct<"union.MemValue", (f64)>, ptr, i32, i16, i8, i8, ptr, i32, i32, ptr, ptr)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %30 = "llvm.load"(%29) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %31 = "llvm.zext"(%30) : (i16) -> i32
    %32 = "llvm.or"(%31, %5) : (i32, i32) -> i32
  ...
  ^bb8:  // pred: ^bb6
    "llvm.br"(%7)[^bb9] : (!llvm.ptr) -> ()
  ^bb9(%41: !llvm.ptr):  // 2 preds: ^bb7, ^bb8
  ...
  ^bb10:  // pred: ^bb0
    ...
    "llvm.store"(%43, %8) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"()[^bb11] : () -> ()
  ^bb11:  // 3 preds: ^bb5, ^bb9, ^bb10
