"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %3 = "llvm.mlir.constant"() <{value = 268435456 : i64}> : () -> i64
    %4 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
    %5 = "llvm.mlir.constant"() <{value = 74 : i32}> : () -> i32
    %6 = "llvm.mlir.zero"() : () -> !llvm.ptr
    %7 = "llvm.mlir.constant"() <{value = 41 : i32}> : () -> i32
    %8 = "llvm.mlir.constant"() <{value = 72 : i32}> : () -> i32
    %9 = "llvm.mlir.constant"() <{value = 75 : i32}> : () -> i32
    ...
    %15 = "llvm.and"(%14, %3) : (i64, i64) -> i64
    %16 = "llvm.icmp"(%15, %4) <{predicate = 1 : i64}> : (i64, i64) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    %20 = "llvm.icmp"(%19, %6) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%20)[^bb2, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
