"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %4 = "llvm.getelementptr"(%3, %2) <{elem_type = !llvm.struct<"struct.sqlite3AutoExtList", (i32, ptr)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %13 = "llvm.sub"(%12, %0) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.store"(%13, %8) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb1] : () -> ()
  ^bb1:  // 2 preds: ^bb0, ^bb5
  ...
  ^bb2:  // pred: ^bb1
    ...
    %19 = "llvm.getelementptr"(%16, %18) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    %23 = "llvm.load"(%3) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %24 = "llvm.add"(%23, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.store"(%24, %3) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    ...
    "llvm.store"(%35, %9) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb6] : () -> ()
  ^bb4:  // pred: ^bb2
    "llvm.br"()[^bb5] : () -> ()
  ^bb5:  // pred: ^bb4
    %36 = "llvm.load"(%8) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %37 = "llvm.add"(%36, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.store"(%37, %8) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
