"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<fastcc>, arg_attrs = [{llvm.nocapture, llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<i32 (ptr, i32)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "sqlite3VdbeBooleanValue", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 2 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ...
  ^bb1:  // pred: ^bb0
    %13 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C/C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C/C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %14 = "llvm.icmp"(%13, %3) <{predicate = 1 : i64}> : (i64, i64) -> i1
    %15 = "llvm.zext"(%14) : (i1) -> i32
    "llvm.br"(%15)[^bb8] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %16 = "llvm.and"(%10, %4) : (i32, i32) -> i32
    %17 = "llvm.icmp"(%16, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%17, %arg1)[^bb3, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %18 = "llvm.and"(%10, %5) : (i32, i32) -> i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    "llvm.br"(%20)[^bb7] : (f64) -> ()
  ^bb5:  // pred: ^bb3
    %21 = "llvm.and"(%10, %6) : (i32, i32) -> i32
    %22 = "llvm.icmp"(%21, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22, %7)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, f64) -> ()
  ^bb6:  // pred: ^bb5
    %23 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}], callee = @sqlite3MemRealValueNoRC, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> f64
    "llvm.br"(%23)[^bb7] : (f64) -> ()
  ^bb7(%24: f64):  // 3 preds: ^bb4, ^bb5, ^bb6
    %25 = "llvm.fcmp"(%24, %7) <{fastmathFlags = #llvm.fastmath<none>, predicate = 13 : i64}> : (f64, f64) -> i1
    %26 = "llvm.zext"(%25) : (i1) -> i32
    "llvm.br"(%26)[^bb8] : (i32) -> ()
  ^bb8(%27: i32):  // 3 preds: ^bb1, ^bb2, ^bb7
    "llvm.return"(%27) : (i32) -> ()
  }) : () -> ()
