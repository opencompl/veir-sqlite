"builtin.module"() ({
  ...
  ^bb1(%5: i32):  // 2 preds: ^bb0, ^bb1
    ...
    %8 = "llvm.call"(%7, %4) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.nonnull, llvm.noundef}], callee = @sqlite3GetToken, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = readwrite, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i64
    %9 = "llvm.load"(%4) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %10 = "llvm.add"(%9, %2) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %11 = "llvm.icmp"(%10, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %12 = "llvm.trunc"(%8) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %13 = "llvm.add"(%5, %12) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.intr.lifetime.end"(%4) : (!llvm.ptr) -> ()
    "llvm.cond_br"(%11, %13)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.return"(%5) : (i32) -> ()
  }) : () -> ()
