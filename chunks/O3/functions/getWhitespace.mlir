"builtin.module"() ({
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb4
    ...
    %11 = "llvm.getelementptr"(%8, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %12 = "llvm.call"(%11, %6) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3GetToken, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i64
  ...
  ^bb4:  // 2 preds: ^bb1, ^bb2
    ...
    %20 = "llvm.add"(%19, %18) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.store"(%20, %5) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb1] : () -> ()
  ^bb5:  // pred: ^bb3
