"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: !llvm.ptr):
    ...
    %2 = "llvm.mlir.constant"() <{value = 86 : i32}> : () -> i32
    %3 = "llvm.mlir.constant"() <{value = 115 : i32}> : () -> i32
    %4 = "llvm.mlir.constant"() <{value = 105 : i32}> : () -> i32
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb9
    ...
    "llvm.store"(%22, %14) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
  ...
  ^bb3:  // pred: ^bb2
    %28 = "llvm.va_arg"(%12) : (!llvm.ptr) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    ...
    %44 = "llvm.va_arg"(%12) : (!llvm.ptr) -> i32
    ...
    %49 = "llvm.call"(%43, %5, %45, %48) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @sqlite3VdbeAddOp2, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i32, i32, i32) -> i32
    "llvm.br"()[^bb7] : () -> ()
  ^bb6:  // pred: ^bb4
    "llvm.br"()[^bb11] : () -> ()
  ^bb7:  // pred: ^bb5
  ...
  ^bb10:  // pred: ^bb1
    ...
    %55 = "llvm.call"(%52, %2, %53, %54) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @sqlite3VdbeAddOp2, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i32, i32, i32) -> i32
    "llvm.br"()[^bb11] : () -> ()
