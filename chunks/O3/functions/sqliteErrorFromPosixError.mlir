"builtin.module"() ({
  ...
  ^bb0(%arg0: i32, %arg1: i32):
    ...
    "llvm.switch"(%6)[^bb3, ^bb1, ^bb1, ^bb1, ^bb1, ^bb1, ^bb1, ^bb2] <{case_operand_segments = array<i32: 0, 0, 0, 0, 0, 0, 0>, case_values = dense<[13, 35, 60, 16, 4, 77, 1]> : vector<7xi32>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i32) -> ()
  ...
  ^bb3:  // pred: ^bb0
    ...
    "llvm.store"(%7, %3) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb4] : () -> ()
