"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %8 = "llvm.mlir.constant"() <{value = 93 : i8}> : () -> i8
  ...
  ^bb3:  // pred: ^bb2
    "llvm.intr.memcpy"(%18, %12, %15) <{arg_attrs = [{llvm.align = 1 : i64, llvm.nonnull}, {llvm.align = 1 : i64, llvm.nonnull, llvm.readonly}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    %20 = "llvm.getelementptr"(%18, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %23 = "llvm.getelementptr"(%4, %5, %22) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %25 = "llvm.icmp"(%24, %6) <{predicate = 4 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%25, %18)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb3
    %26 = "llvm.icmp"(%21, %7) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %27 = "llvm.select"(%26, %8, %21) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    "llvm.br"(%5, %9)[^bb5] : (i64, i32) -> ()
  ...
  ^bb7(%39: i8, %40: i32):  // 2 preds: ^bb5, ^bb6
    %41 = "llvm.getelementptr"(%18, %28) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb8:  // pred: ^bb6
    ...
    %45 = "llvm.getelementptr"(%18, %44) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
