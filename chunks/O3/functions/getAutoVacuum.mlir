"builtin.module"() ({
  ...
  ^bb1(%12: !llvm.ptr, %13: !llvm.ptr):  // 2 preds: ^bb0, ^bb4
    ...
    %15 = "llvm.load"(%12) <{alignment = 1 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C/C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C/C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i8
    %16 = "llvm.icmp"(%14, %15) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%16)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %17 = "llvm.icmp"(%14, %8) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%17, %5)[^bb14, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb1
    %18 = "llvm.zext"(%14) : (i8) -> i64
    ...
    %24 = "llvm.icmp"(%20, %23) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%24, %3, %arg0)[^bb4, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb4:  // 2 preds: ^bb2, ^bb3
    %25 = "llvm.getelementptr"(%13, %10) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.getelementptr"(%12, %10) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%26, %25)[^bb1] : (!llvm.ptr, !llvm.ptr) -> ()
  ^bb5(%27: !llvm.ptr, %28: !llvm.ptr):  // 2 preds: ^bb3, ^bb8
  ...
  ^bb6:  // pred: ^bb5
    %32 = "llvm.icmp"(%29, %8) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%32, %0)[^bb14, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb7:  // pred: ^bb5
    %33 = "llvm.zext"(%29) : (i8) -> i64
    %34 = "llvm.getelementptr"(%2, %33) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %36 = "llvm.zext"(%30) : (i8) -> i64
    %37 = "llvm.getelementptr"(%2, %36) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %39 = "llvm.icmp"(%35, %38) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%39, %4, %arg0)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb8:  // 2 preds: ^bb6, ^bb7
    %40 = "llvm.getelementptr"(%28, %10) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %41 = "llvm.getelementptr"(%27, %10) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%41, %40)[^bb5] : (!llvm.ptr, !llvm.ptr) -> ()
  ^bb9(%42: !llvm.ptr, %43: !llvm.ptr):  // 2 preds: ^bb7, ^bb12
  ...
  ^bb10:  // pred: ^bb9
    %47 = "llvm.icmp"(%44, %8) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%47, %9)[^bb14, ^bb12] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb11:  // pred: ^bb9
    %48 = "llvm.zext"(%44) : (i8) -> i64
    %49 = "llvm.getelementptr"(%2, %48) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %51 = "llvm.zext"(%45) : (i8) -> i64
    %52 = "llvm.getelementptr"(%2, %51) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
