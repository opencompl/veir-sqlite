"builtin.module"() ({
  ...
  ^bb4:  // pred: ^bb3
    %21 = "llvm.call"(%3) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3MutexAlloc, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i32) -> !llvm.ptr
    ...
    %24 = "llvm.load"(%1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %25 = "llvm.icmp"(%23, %24) <{predicate = 9 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%25)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.store"(%7, %13) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
  ...
  ^bb7:  // 2 preds: ^bb5, ^bb6
    ...
    %33 = "llvm.icmp"(%32, %7) <{predicate = 1 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
  ...
  ^bb8:  // pred: ^bb7
    ...
    %37 = "llvm.call"(%34, %35, %14, %36) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
  ...
  ^bb11:  // pred: ^bb10
    ...
    "llvm.store"(%44, %10) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
