"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: !llvm.ptr, %arg5: !llvm.ptr):
    ...
    %5 = "llvm.getelementptr"(%4, %1) <{elem_type = !llvm.struct<"struct.Sqlite3Config", (i32, i8, i8, i8, i8, i8, i8, i32, i32, i32, i32, i32, struct<"struct.sqlite3_mem_methods", (ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr)>, struct<"struct.sqlite3_mutex_methods", (ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr)>, struct<"struct.sqlite3_pcache_methods2", (i32, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr)>, ptr, i32, i32, i32, i64, i64, ptr, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, ptr, ptr, ptr, i64, ptr, i32, ptr, i32, i32, i32)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %20 = "llvm.mlir.addressof"() <{global_name = @".str.1104"}> : () -> !llvm.ptr
    %21 = "llvm.mlir.constant"() <{value = 9 : i64}> : () -> i64
    %22 = "llvm.mlir.constant"() <{value = 35 : i32}> : () -> i32
    ...
    %30 = "llvm.mlir.addressof"() <{global_name = @sqlite3ParseUri.aCacheMode}> : () -> !llvm.ptr
  ...
  ^bb7:  // pred: ^bb6
    ...
    %113 = "llvm.add"(%112, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb12:  // pred: ^bb11
    "llvm.store"(%18, %64) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb13] : () -> ()
  ...
  ^bb16:  // pred: ^bb15
    ...
    %148 = "llvm.add"(%147, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb17:  // pred: ^bb15
    ...
    %150 = "llvm.icmp"(%149, %18) <{predicate = 1 : i64}> : (i64, i64) -> i1
  ...
  ^bb18:  // pred: ^bb17
    ...
    %152 = "llvm.icmp"(%151, %19) <{predicate = 1 : i64}> : (i64, i64) -> i1
  ...
  ^bb19:  // pred: ^bb18
    ...
    %154 = "llvm.getelementptr"(%153, %18) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %155 = "llvm.call"(%20, %154, %21) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
  ...
  ^bb20:  // 2 preds: ^bb18, ^bb19
    ...
    %158 = "llvm.sub"(%157, %18) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb24:  // pred: ^bb23
    ...
    %172 = "llvm.icmp"(%171, %22) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.br"(%172)[^bb25] : (i1) -> ()
  ...
  ^bb26:  // pred: ^bb25
    ...
    %175 = "llvm.add"(%174, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb28:  // pred: ^bb27
    ...
    %191 = "llvm.add"(%190, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb29:  // pred: ^bb28
    ...
    %202 = "llvm.add"(%201, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %211 = "llvm.add"(%210, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb32:  // pred: ^bb31
    ...
    %229 = "llvm.icmp"(%228, %22) <{predicate = 1 : i64}> : (i32, i32) -> i1
  ...
  ^bb42:  // pred: ^bb41
    ...
    %251 = "llvm.add"(%250, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb48:  // 2 preds: ^bb46, ^bb47
    ...
    %264 = "llvm.sub"(%263, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb51:  // pred: ^bb50
    ...
    %280 = "llvm.icmp"(%279, %22) <{predicate = 1 : i64}> : (i32, i32) -> i1
  ...
  ^bb52:  // pred: ^bb51
    ...
    %283 = "llvm.sub"(%282, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb54:  // pred: ^bb53
    ...
    %290 = "llvm.add"(%289, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb57:  // pred: ^bb56
    ...
    %296 = "llvm.add"(%295, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    "llvm.store"(%24, %297) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.br"()[^bb59] : () -> ()
  ^bb58:  // pred: ^bb56
    "llvm.store"(%45, %63) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb59] : () -> ()
  ^bb59:  // 2 preds: ^bb57, ^bb58
    "llvm.store"(%24, %59) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.br"()[^bb66] : () -> ()
  ...
  ^bb67:  // 2 preds: ^bb44, ^bb66
    ...
    %311 = "llvm.add"(%310, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb69:  // pred: ^bb68
    ...
    %317 = "llvm.add"(%316, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    "llvm.store"(%24, %318) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.br"()[^bb70] : () -> ()
  ^bb70:  // 2 preds: ^bb68, ^bb69
    ...
    %330 = "llvm.add"(%329, %23) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
  ...
  ^bb71:  // 2 preds: ^bb70, ^bb95
    ...
    %335 = "llvm.icmp"(%334, %24) <{predicate = 1 : i64}> : (i8, i8) -> i1
  ...
  ^bb72:  // pred: ^bb71
    ...
    %340 = "llvm.add"(%339, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %345 = "llvm.icmp"(%344, %26) <{predicate = 0 : i64}> : (i64, i64) -> i1
  ...
  ^bb73:  // pred: ^bb72
    ...
    %347 = "llvm.call"(%27, %346, %26) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
  ...
  ^bb76:  // pred: ^bb75
    ...
    %353 = "llvm.call"(%28, %352, %6) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %354 = "llvm.icmp"(%353, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%354)[^bb77, ^bb78] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb77:  // pred: ^bb76
    "llvm.store"(%29, %73) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.store"(%30, %71) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    "llvm.store"(%28, %72) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"()[^bb78] : () -> ()
  ...
  ^bb79:  // pred: ^bb78
    ...
    %359 = "llvm.call"(%31, %358, %13) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %360 = "llvm.icmp"(%359, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%360)[^bb80, ^bb81] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb80:  // pred: ^bb79
    "llvm.store"(%32, %73) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.store"(%33, %71) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
  ...
  ^bb91:  // pred: ^bb89
    ...
    %403 = "llvm.and"(%402, %35) : (i32, i32) -> i32
  ...
  ^bb93:  // pred: ^bb91
    ...
    %412 = "llvm.xor"(%411, %36) : (i32, i32) -> i32
  ...
  ^bb95:  // 2 preds: ^bb74, ^bb94
    ...
    %418 = "llvm.add"(%417, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb103:  // pred: ^bb102
    ...
    %456 = "llvm.call"(%25, %455) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3_mprintf, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, var_callee_type = !llvm.func<ptr (ptr, ...)>}> : (!llvm.ptr, !llvm.ptr) -> !llvm.ptr
