"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %16 = "llvm.getelementptr"(%15, %0) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%16, %14) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %17 = "llvm.load"(%15) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %18 = "llvm.zext"(%17) : (i8) -> i32
    "llvm.store"(%18, %13) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %19 = "llvm.load"(%13) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %20 = "llvm.icmp"(%19, %1) <{predicate = 9 : i64}> : (i32, i32) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    %24 = "llvm.getelementptr"(%2, %3, %23) <{elem_type = !llvm.array<64 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    ...
    %34 = "llvm.shl"(%33, %10) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    ...
    "llvm.store"(%37, %35) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %38 = "llvm.load"(%36) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %39 = "llvm.zext"(%38) : (i8) -> i32
    %40 = "llvm.and"(%11, %39) : (i32, i32) -> i32
    %41 = "llvm.add"(%34, %40) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
  ...
  ^bb4:  // pred: ^bb2
    ...
    "llvm.cond_br"(%43)[^bb7, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %44 = "llvm.load"(%13) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %45 = "llvm.and"(%44, %5) : (i32, i32) -> i32
