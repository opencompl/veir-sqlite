"builtin.module"() ({
  ...
  ^bb0(%arg0: i16):
    ...
    %4 = "llvm.alloca"(%0) <{alignment = 2 : i64, elem_type = i16}> : (i32) -> !llvm.ptr
    "llvm.store"(%arg0, %4) <{alignment = 2 : i64, ordering = 0 : i64}> : (i16, !llvm.ptr) -> ()
    %5 = "llvm.load"(%4) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %6 = "llvm.sext"(%5) : (i16) -> i32
    %7 = "llvm.icmp"(%6, %1) <{predicate = 3 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%7)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    "llvm.br"(%3)[^bb3] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %8 = "llvm.load"(%4) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %9 = "llvm.sext"(%8) : (i16) -> i64
    %10 = "llvm.call"(%9) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3LogEst, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.signext}]}> : (i64) -> i16
    %11 = "llvm.sext"(%10) : (i16) -> i32
    %12 = "llvm.sub"(%11, %2) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%12)[^bb3] : (i32) -> ()
