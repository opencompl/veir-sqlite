"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %6 = "llvm.mlir.addressof"() <{global_name = @".str.1346"}> : () -> !llvm.ptr
    %7 = "llvm.mlir.addressof"() <{global_name = @".str.1348"}> : () -> !llvm.ptr
    %8 = "llvm.mlir.addressof"() <{global_name = @".str.1347"}> : () -> !llvm.ptr
    %9 = "llvm.mlir.constant"() <{value = 255 : i32}> : () -> i32
    %10 = "llvm.mlir.constant"() <{value = 29 : i32}> : () -> i32
    %11 = "llvm.mlir.addressof"() <{global_name = @".str.1345"}> : () -> !llvm.ptr
    %12 = "llvm.mlir.constant"() <{value = 21037060 : i64}> : () -> i64
    %13 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i64
    %14 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
    %15 = "llvm.mlir.addressof"() <{global_name = @sqlite3ErrStr.aMsg}> : () -> !llvm.ptr
    %16 = "llvm.mlir.constant"() <{value = 1 : i8}> : () -> i8
    %17 = "llvm.mlir.zero"() : () -> !llvm.ptr
    %18 = "llvm.icmp"(%arg1, %0) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %19 = "llvm.select"(%18, %1, %arg1) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    ...
    "llvm.cond_br"(%25)[^bb8, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    "llvm.switch"(%arg1, %6)[^bb4, ^bb7, ^bb2, ^bb3] <{case_operand_segments = array<i32: 1, 0, 0>, case_values = dense<[516, 100, 101]> : vector<3xi32>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i32, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.br"(%8)[^bb7] : (!llvm.ptr) -> ()
  ^bb3:  // pred: ^bb1
    "llvm.br"(%7)[^bb7] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb1
    %26 = "llvm.and"(%arg1, %9) : (i32, i32) -> i32
    %27 = "llvm.icmp"(%26, %10) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%27, %11)[^bb5, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb5:  // pred: ^bb4
    %28 = "llvm.zext"(%26) <{nonNeg}> : (i32) -> i64
    %29 = "llvm.lshr"(%12, %28) : (i64, i64) -> i64
    %30 = "llvm.and"(%29, %13) : (i64, i64) -> i64
    %31 = "llvm.icmp"(%30, %14) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%31, %11)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb6:  // pred: ^bb5
    %32 = "llvm.getelementptr"(%15, %14, %28) <{elem_type = !llvm.array<29 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %33 = "llvm.load"(%32) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C/C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C/C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%33)[^bb7] : (!llvm.ptr) -> ()
  ^bb7(%34: !llvm.ptr):  // 6 preds: ^bb1, ^bb2, ^bb3, ^bb4, ^bb5, ^bb6
    "llvm.call"(%arg0, %34, %1, %16, %17) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef, llvm.zeroext}, {llvm.noundef}], callee = @setResultStrOrError, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, !llvm.ptr, i32, i8, !llvm.ptr) -> ()
    "llvm.br"()[^bb8] : () -> ()
  ^bb8:  // 2 preds: ^bb0, ^bb7
    "llvm.return"() : () -> ()
  }) : () -> ()
