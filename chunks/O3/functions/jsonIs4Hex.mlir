"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%15, %4)[^bb4, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %19 = "llvm.getelementptr"(%0, %1, %18) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %21 = "llvm.and"(%20, %2) : (i8, i8) -> i8
    %22 = "llvm.icmp"(%21, %3) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%22, %4)[^bb4, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    %23 = "llvm.getelementptr"(%arg0, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %26 = "llvm.getelementptr"(%0, %1, %25) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %28 = "llvm.and"(%27, %2) : (i8, i8) -> i8
    %29 = "llvm.icmp"(%28, %3) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%29, %4)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    ...
    %33 = "llvm.getelementptr"(%0, %1, %32) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %35 = "llvm.lshr"(%34, %8) : (i8, i8) -> i8
    %36 = "llvm.and"(%35, %9) : (i8, i8) -> i8
    %37 = "llvm.zext"(%36) <{nonNeg}> : (i8) -> i32
    "llvm.br"(%37)[^bb4] : (i32) -> ()
  ^bb4(%38: i32):  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb3
    "llvm.return"(%38) : (i32) -> ()
  }) : () -> ()
