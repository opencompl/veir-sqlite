"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %9 = "llvm.getelementptr"(%8, %1) <{elem_type = !llvm.struct<"struct.RCStr", (i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %11 = "llvm.getelementptr"(%10, %2) <{elem_type = !llvm.struct<"struct.RCStr", (i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %12 = "llvm.load"(%11) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %13 = "llvm.icmp"(%12, %3) <{predicate = 9 : i64}> : (i64, i64) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    %15 = "llvm.getelementptr"(%14, %2) <{elem_type = !llvm.struct<"struct.RCStr", (i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %16 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %17 = "llvm.add"(%16, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
