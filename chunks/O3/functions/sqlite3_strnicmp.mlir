"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %18 = "llvm.select"(%16, %2, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    "llvm.store"(%18, %7) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb15] : () -> ()
  ^bb2:  // pred: ^bb0
  ...
  ^bb6:  // 2 preds: ^bb5, ^bb10
    ...
    "llvm.store"(%24, %10) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %25 = "llvm.icmp"(%23, %3) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%25, %4)[^bb7, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    ...
    "llvm.cond_br"(%29, %4)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb8:  // pred: ^bb7
    ...
    %33 = "llvm.getelementptr"(%5, %6, %32) <{elem_type = !llvm.array<274 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %39 = "llvm.getelementptr"(%5, %6, %38) <{elem_type = !llvm.array<274 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %40 = "llvm.load"(%39) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %41 = "llvm.zext"(%40) : (i8) -> i32
    %42 = "llvm.icmp"(%35, %41) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%42)[^bb9] : (i1) -> ()
  ^bb9(%43: i1):  // 3 preds: ^bb6, ^bb7, ^bb8
  ...
  ^bb10:  // pred: ^bb9
    ...
    "llvm.store"(%45, %11) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %46 = "llvm.load"(%12) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %47 = "llvm.getelementptr"(%46, %0) <{elem_type = i8, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%47, %12) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
  ...
  ^bb11:  // pred: ^bb9
    ...
    %49 = "llvm.icmp"(%48, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
  ...
  ^bb13:  // pred: ^bb11
    ...
    %53 = "llvm.getelementptr"(%5, %6, %52) <{elem_type = !llvm.array<274 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %59 = "llvm.getelementptr"(%5, %6, %58) <{elem_type = !llvm.array<274 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %60 = "llvm.load"(%59) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %61 = "llvm.zext"(%60) : (i8) -> i32
    %62 = "llvm.sub"(%55, %61) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%62)[^bb14] : (i32) -> ()
  ^bb14(%63: i32):  // 2 preds: ^bb12, ^bb13
    "llvm.store"(%63, %7) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb15] : () -> ()
  ^bb15:  // 3 preds: ^bb1, ^bb3, ^bb14
    %64 = "llvm.load"(%7) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.return"(%64) : (i32) -> ()
  }) : () -> ()
