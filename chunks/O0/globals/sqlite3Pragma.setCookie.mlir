"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, linkage = #llvm.linkage<external>, sym_name = "sqlite3Pragma.setCookie", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
    %0 = "llvm.mlir.constant"() <{value = 0 : i8}> : () -> i8
    %1 = "llvm.mlir.constant"() <{value = 102 : i8}> : () -> i8
    ...
    %12 = "llvm.insertvalue"(%11, %7) <{position = array<i64: 2>}> : (!llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>, i8) -> !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>
    ...
    %14 = "llvm.mlir.undef"() : () -> !llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %15 = "llvm.insertvalue"(%14, %13) <{position = array<i64: 0>}> : (!llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %16 = "llvm.insertvalue"(%15, %6) <{position = array<i64: 1>}> : (!llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    "llvm.return"(%16) : (!llvm.array<2 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>) -> ()
  }) : () -> ()
