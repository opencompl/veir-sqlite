"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, linkage = #llvm.linkage<external>, sym_name = "sqlite3_blob_open.openBlob", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
    ...
    %1 = "llvm.mlir.constant"() <{value = 72 : i8}> : () -> i8
    ...
    %8 = "llvm.mlir.constant"() <{value = 86 : i8}> : () -> i8
    ...
    %11 = "llvm.insertvalue"(%10, %7) <{position = array<i64: 1>}> : (!llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>, i8) -> !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>
    ...
    %14 = "llvm.mlir.constant"() <{value = 96 : i8}> : () -> i8
    ...
    %19 = "llvm.insertvalue"(%18, %7) <{position = array<i64: 3>}> : (!llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>, i8) -> !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>
    %20 = "llvm.mlir.constant"() <{value = 5 : i8}> : () -> i8
    %21 = "llvm.mlir.constant"() <{value = 31 : i8}> : () -> i8
    ...
    %26 = "llvm.insertvalue"(%25, %7) <{position = array<i64: 3>}> : (!llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>, i8) -> !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>
    ...
    %33 = "llvm.mlir.constant"() <{value = -85 : i8}> : () -> i8
    ...
    %39 = "llvm.mlir.undef"() : () -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %40 = "llvm.insertvalue"(%39, %38) <{position = array<i64: 0>}> : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %41 = "llvm.insertvalue"(%40, %32) <{position = array<i64: 1>}> : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %42 = "llvm.insertvalue"(%41, %26) <{position = array<i64: 2>}> : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %43 = "llvm.insertvalue"(%42, %19) <{position = array<i64: 3>}> : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %44 = "llvm.insertvalue"(%43, %13) <{position = array<i64: 4>}> : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %45 = "llvm.insertvalue"(%44, %6) <{position = array<i64: 5>}> : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    "llvm.return"(%45) : (!llvm.array<6 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>) -> ()
  }) : () -> ()
