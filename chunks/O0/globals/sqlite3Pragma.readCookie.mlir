"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, linkage = #llvm.linkage<external>, sym_name = "sqlite3Pragma.readCookie", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
    ...
    %8 = "llvm.mlir.constant"() <{value = 101 : i8}> : () -> i8
    ...
    %20 = "llvm.mlir.undef"() : () -> !llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %21 = "llvm.insertvalue"(%20, %19) <{position = array<i64: 0>}> : (!llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %22 = "llvm.insertvalue"(%21, %13) <{position = array<i64: 1>}> : (!llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    %23 = "llvm.insertvalue"(%22, %7) <{position = array<i64: 2>}> : (!llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>, !llvm.struct<"struct.VdbeOpList", (i8, i8, i8, i8)>) -> !llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>
    "llvm.return"(%23) : (!llvm.array<3 x struct<"struct.VdbeOpList", (i8, i8, i8, i8)>>) -> ()
  }) : () -> ()
