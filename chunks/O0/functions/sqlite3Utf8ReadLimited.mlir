"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %15 = "llvm.getelementptr"(%3, %0, %14) <{elem_type = !llvm.array<64 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
