"builtin.module"() ({
  ...
  ^bb0(%arg0: i32, %arg1: i64, %arg2: !llvm.ptr, %arg3: i32, %arg4: !llvm.ptr):
    ...
    %7 = "llvm.getelementptr"(%6, %2) <{elem_type = !llvm.struct<"struct.unix_syscall", (ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
