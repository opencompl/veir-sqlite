"builtin.module"() ({
  ...
  ^bb0(%arg0: i32, %arg1: i64, %arg2: !llvm.ptr, %arg3: i32, %arg4: !llvm.ptr):
    ...
    %7 = "llvm.getelementptr"(%6, %2) <{elem_type = !llvm.struct<"struct.unix_syscall", (ptr, ptr, ptr)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %8 = "llvm.mlir.constant"() <{value = false}> : () -> i1
    %9 = "llvm.mlir.constant"() <{value = 4 : i32}> : () -> i32
    %10 = "llvm.and"(%arg3, %0) : (i32, i32) -> i32
    "llvm.br"()[^bb1] : () -> ()
  ^bb1:  // 2 preds: ^bb0, ^bb4
    %11 = "llvm.load"(%7) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %12 = "llvm.sext"(%10) : (i32) -> i64
    %13 = "llvm.call"(%11, %arg0, %arg2, %12, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, i32, !llvm.ptr, i64, i64) -> i64
    %14 = "llvm.trunc"(%13) <{overflowFlags = 0 : i32}> : (i64) -> i32
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // pred: ^bb1
    %15 = "llvm.icmp"(%14, %2) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%15, %8)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    ...
    %18 = "llvm.icmp"(%17, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%18)[^bb4] : (i1) -> ()
  ^bb4(%19: i1):  // 2 preds: ^bb2, ^bb3
    "llvm.cond_br"(%19)[^bb1, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %20 = "llvm.icmp"(%14, %2) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%20)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb5
    %21 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @__error, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>}> : () -> !llvm.ptr
    %22 = "llvm.load"(%21) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.store"(%22, %arg4) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 2 preds: ^bb5, ^bb6
    "llvm.return"(%14) : (i32) -> ()
  }) : () -> ()
