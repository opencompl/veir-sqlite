"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %8 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    %11 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %14 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %16 = "llvm.getelementptr"(%15, %1) <{elem_type = !llvm.struct<"struct.SorterFile", (ptr, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    ...
    %21 = "llvm.getelementptr"(%20, %1) <{elem_type = !llvm.struct<"struct.SorterFile", (ptr, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4:  // 2 preds: ^bb2, ^bb3
    ...
    %25 = "llvm.getelementptr"(%24, %1) <{elem_type = !llvm.struct<"struct.SorterFile", (ptr, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    %28 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %30 = "llvm.getelementptr"(%29, %1) <{elem_type = !llvm.struct<"struct.SorterFile", (ptr, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // 2 preds: ^bb4, ^bb5
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 2 preds: ^bb1, ^bb6
    %32 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
