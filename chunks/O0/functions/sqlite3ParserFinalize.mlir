"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %8 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    %14 = "llvm.getelementptr"(%10, %0) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    %18 = "llvm.getelementptr"(%10, %0) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %19 = "llvm.load"(%18) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %20 = "llvm.getelementptr"(%10, %0) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb1
    %22 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %23 = "llvm.load"(%22) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %24 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %27 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %28 = "llvm.load"(%27) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %29 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
