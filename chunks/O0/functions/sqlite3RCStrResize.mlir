"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64):
    ...
    %5 = "llvm.add"(%arg1, %1) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %6 = "llvm.add"(%5, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %7 = "llvm.call"(%4, %6) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3_realloc64, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %8 = "llvm.icmp"(%7, %3) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
  ...
  ^bb2:  // pred: ^bb0
    %9 = "llvm.getelementptr"(%7, %2) <{elem_type = !llvm.struct<"struct.RCStr", (i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
