"builtin.module"() ({
  ...
  ^bb3(%28: !llvm.ptr, %29: i32, %30: i32):  // 3 preds: ^bb2, ^bb14, ^bb18
    ...
    %32 = "llvm.getelementptr"(%28, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    ...
    %43 = "llvm.getelementptr"(%33, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb7(%45: !llvm.ptr, %46: i32):  // 2 preds: ^bb6, ^bb8
    ...
    %50 = "llvm.getelementptr"(%5, %0, %49) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb8:  // pred: ^bb7
    %55 = "llvm.getelementptr"(%45, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb13:  // pred: ^bb12
    %65 = "llvm.getelementptr"(%22, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb17:  // pred: ^bb16
    %75 = "llvm.getelementptr"(%22, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb20:  // pred: ^bb16
    ...
    %84 = "llvm.getelementptr"(%5, %0, %83) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb22(%89: !llvm.ptr):  // 2 preds: ^bb21, ^bb23
    %90 = "llvm.getelementptr"(%89, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.br"()[^bb23] : () -> ()
  ^bb23:  // pred: ^bb22
    ...
    %94 = "llvm.getelementptr"(%5, %0, %93) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb30:  // pred: ^bb29
    %110 = "llvm.getelementptr"(%102, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %114 = "llvm.getelementptr"(%5, %0, %113) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb35(%132: i64, %133: i32, %134: i32):  // 2 preds: ^bb33, ^bb34
    "llvm.br"()[^bb36] : () -> ()
  ^bb36:  // pred: ^bb35
    %135 = "llvm.getelementptr"(%120, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %136 = "llvm.load"(%135) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %137 = "llvm.zext"(%136) : (i8) -> i64
    %138 = "llvm.getelementptr"(%5, %0, %137) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb47:  // 2 preds: ^bb45, ^bb46
    %160 = "llvm.getelementptr"(%150, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb48:  // pred: ^bb47
    %164 = "llvm.getelementptr"(%160, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb50:  // pred: ^bb49
    %168 = "llvm.getelementptr"(%160, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb53:  // pred: ^bb52
    %177 = "llvm.getelementptr"(%170, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb58(%189: i32):  // 2 preds: ^bb56, ^bb57
    %190 = "llvm.getelementptr"(%179, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb69:  // pred: ^bb67
    ...
    %214 = "llvm.getelementptr"(%5, %0, %213) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb71(%219: !llvm.ptr):  // 2 preds: ^bb70, ^bb72
    %220 = "llvm.getelementptr"(%219, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.br"()[^bb72] : () -> ()
  ^bb72:  // pred: ^bb71
    %221 = "llvm.load"(%220) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %222 = "llvm.zext"(%221) : (i8) -> i64
    %223 = "llvm.getelementptr"(%5, %0, %222) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
