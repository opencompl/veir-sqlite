"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %2 = "llvm.mlir.constant"() <{value = 47 : i32}> : () -> i32
    %3 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %4 = "llvm.mlir.constant"() <{value = 0 : i8}> : () -> i8
    "llvm.br"(%0, %0)[^bb1] : (i32, i32) -> ()
  ^bb1(%5: i32, %6: i32):  // 2 preds: ^bb0, ^bb9
    "llvm.br"(%5)[^bb2] : (i32) -> ()
  ^bb2(%7: i32):  // 2 preds: ^bb1, ^bb5
    %8 = "llvm.sext"(%7) : (i32) -> i64
    %9 = "llvm.getelementptr"(%arg1, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%12, %1)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
  ...
  ^bb7:  // pred: ^bb6
    ...
    %23 = "llvm.sub"(%7, %6) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.call"(%arg0, %22, %23) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @appendOnePathElement, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i32) -> ()
    "llvm.br"()[^bb8] : () -> ()
  ^bb8:  // 2 preds: ^bb6, ^bb7
    %24 = "llvm.add"(%7, %3) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // pred: ^bb8
    %25 = "llvm.add"(%7, %3) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %26 = "llvm.sext"(%7) : (i32) -> i64
    ...
    "llvm.cond_br"(%29, %25, %24)[^bb1, ^bb10] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i32, i32) -> ()
  ^bb10:  // pred: ^bb9
    "llvm.return"() : () -> ()
  }) : () -> ()
