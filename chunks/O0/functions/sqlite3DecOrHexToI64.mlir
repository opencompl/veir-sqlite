"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %5 = "llvm.mlir.addressof"() <{global_name = @".str.1358"}> : () -> !llvm.ptr
    ...
    "llvm.cond_br"(%19)[^bb1, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.cond_br"(%27)[^bb3, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // 2 preds: ^bb1, ^bb2
    "llvm.br"(%10)[^bb4] : (i32) -> ()
  ^bb4(%28: i32):  // 2 preds: ^bb3, ^bb6
  ...
  ^bb5:  // pred: ^bb4
    "llvm.br"()[^bb6] : () -> ()
  ^bb6:  // pred: ^bb5
    %34 = "llvm.add"(%28, %8) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%34)[^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32) -> ()
  ^bb7:  // pred: ^bb4
    "llvm.br"(%0, %28)[^bb8] : (i64, i32) -> ()
  ^bb8(%35: i64, %36: i32):  // 2 preds: ^bb7, ^bb10
    ...
    %41 = "llvm.getelementptr"(%11, %0, %40) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %42 = "llvm.load"(%41) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %43 = "llvm.zext"(%42) : (i8) -> i32
    %44 = "llvm.and"(%43, %12) : (i32, i32) -> i32
    %45 = "llvm.icmp"(%44, %13) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%45)[^bb9, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    %46 = "llvm.mul"(%35, %15) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %47 = "llvm.sext"(%36) : (i32) -> i64
    ...
    %51 = "llvm.call"(%50) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3HexToInt, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.zeroext}]}> : (i32) -> i8
    %52 = "llvm.zext"(%51) : (i8) -> i64
    %53 = "llvm.add"(%46, %52) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.br"()[^bb10] : () -> ()
  ^bb10:  // pred: ^bb9
    %54 = "llvm.add"(%36, %8) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%53, %54)[^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i64, i32) -> ()
  ^bb11:  // pred: ^bb8
    "llvm.store"(%35, %arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %55 = "llvm.sub"(%36, %28) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %56 = "llvm.icmp"(%55, %14) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%56)[^bb12, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb12:  // pred: ^bb11
    "llvm.br"(%10)[^bb19] : (i32) -> ()
  ^bb13:  // pred: ^bb11
    %57 = "llvm.sext"(%36) : (i32) -> i64
