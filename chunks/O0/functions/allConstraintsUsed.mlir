"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    %6 = "llvm.getelementptr"(%5, %0) <{elem_type = !llvm.struct<"struct.sqlite3_index_constraint_usage", (i32, i8)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
