"builtin.module"() ({
  ...
  ^bb1(%6: i32, %7: i32):  // 2 preds: ^bb0, ^bb5
    %8 = "llvm.icmp"(%6, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
  ...
  ^bb2:  // pred: ^bb1
    ...
    %13 = "llvm.getelementptr"(%2, %3, %12) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    "llvm.br"(%0)[^bb7] : (i32) -> ()
  ^bb4:  // pred: ^bb2
    %18 = "llvm.shl"(%7, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %19 = "llvm.sext"(%6) : (i32) -> i64
    ...
    %23 = "llvm.call"(%22) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3HexToInt, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.zeroext}]}> : (i32) -> i8
    %24 = "llvm.zext"(%23) : (i8) -> i32
    %25 = "llvm.add"(%18, %24) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.br"()[^bb5] : () -> ()
  ^bb5:  // pred: ^bb4
    %26 = "llvm.add"(%6, %1) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%26, %25)[^bb1] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32, i32) -> ()
  ^bb6:  // pred: ^bb1
    "llvm.store"(%7, %arg2) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"(%1)[^bb7] : (i32) -> ()
  ^bb7(%27: i32):  // 2 preds: ^bb3, ^bb6
    "llvm.return"(%27) : (i32) -> ()
  }) : () -> ()
