"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: i8, %arg3: i32):
    ...
    %8 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IntegrityCk", (ptr, ptr, ptr, i32, i32, i32, i32, i32, ptr, i32, i32, i32, struct<"struct.sqlite3_str", (ptr, ptr, i32, i32, i32, i8, i8)>, ptr, ptr, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
