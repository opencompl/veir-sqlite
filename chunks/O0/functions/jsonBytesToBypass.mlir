"builtin.module"() ({
  ...
  ^bb12:  // pred: ^bb6
    ...
    %46 = "llvm.getelementptr"(%arg0, %45) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb16:  // pred: ^bb15
    ...
    %66 = "llvm.getelementptr"(%arg0, %65) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
