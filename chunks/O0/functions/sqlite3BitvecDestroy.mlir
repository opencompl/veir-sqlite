"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    "llvm.br"()[^bb9] : () -> ()
  ^bb2:  // pred: ^bb0
    %8 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.Bitvec", (i32, i32, i32, struct<"union.anon.22", (array<62 x ptr>)>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %9 = "llvm.load"(%8) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %10 = "llvm.icmp"(%9, %1) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%10)[^bb3, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    "llvm.br"(%1)[^bb4] : (i32) -> ()
  ^bb4(%11: i32):  // 2 preds: ^bb3, ^bb6
    %12 = "llvm.icmp"(%11, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%12)[^bb5, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %13 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.Bitvec", (i32, i32, i32, struct<"union.anon.22", (array<62 x ptr>)>)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %14 = "llvm.zext"(%11) : (i32) -> i64
    %15 = "llvm.getelementptr"(%13, %5, %14) <{elem_type = !llvm.array<62 x ptr>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %16 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.call"(%16) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3BitvecDestroy, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> ()
    "llvm.br"()[^bb6] : () -> ()
  ^bb6:  // pred: ^bb5
    %17 = "llvm.add"(%11, %6) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.br"(%17)[^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32) -> ()
  ^bb7:  // pred: ^bb4
    "llvm.br"()[^bb8] : () -> ()
  ^bb8:  // 2 preds: ^bb2, ^bb7
