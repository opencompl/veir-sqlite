"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    %0 = "llvm.mlir.addressof"() <{global_name = @".str.1348"}> : () -> !llvm.ptr
    %1 = "llvm.mlir.addressof"() <{global_name = @".str.1347"}> : () -> !llvm.ptr
    %2 = "llvm.mlir.addressof"() <{global_name = @".str.1346"}> : () -> !llvm.ptr
