"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %7 = "llvm.select"(%5, %2, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    "llvm.br"(%7)[^bb6] : (i32) -> ()
  ^bb2:  // pred: ^bb0
  ...
  ^bb4:  // pred: ^bb2
    "llvm.br"()[^bb5] : () -> ()
  ^bb5:  // pred: ^bb4
    %9 = "llvm.call"(%arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3StrICmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i32
    "llvm.br"(%9)[^bb6] : (i32) -> ()
  ^bb6(%10: i32):  // 3 preds: ^bb1, ^bb3, ^bb5
    "llvm.return"(%10) : (i32) -> ()
  }) : () -> ()
