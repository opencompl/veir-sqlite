"builtin.module"() ({
  ...
  ^bb3(%2: i32):  // 2 preds: ^bb1, ^bb2
    ...
    %4 = "llvm.call"(%arg0, %3) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3_result_zeroblob64, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> i32
    "llvm.return"() : () -> ()
  }) : () -> ()
