"builtin.module"() ({
  ...
  ^bb6:  // 2 preds: ^bb4, ^bb5
    ...
    %23 = "llvm.getelementptr"(%22, %0) <{elem_type = !llvm.struct<"struct.Db", (ptr, ptr, i8, i8, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
