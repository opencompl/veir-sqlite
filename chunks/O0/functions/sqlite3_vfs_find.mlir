"builtin.module"() ({
  ...
  ^bb8:  // pred: ^bb6
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // pred: ^bb8
    %17 = "llvm.getelementptr"(%10, %0) <{elem_type = !llvm.struct<"struct.sqlite3_vfs", (i32, i32, i32, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
