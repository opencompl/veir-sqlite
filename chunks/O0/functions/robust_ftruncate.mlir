"builtin.module"() ({
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb4
    ...
    %10 = "llvm.call"(%9, %arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i64) -> i32
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // pred: ^bb1
    %11 = "llvm.icmp"(%10, %1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%11, %7)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    %12 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @__error, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>}> : () -> !llvm.ptr
    %13 = "llvm.load"(%12) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %14 = "llvm.icmp"(%13, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%14)[^bb4] : (i1) -> ()
  ^bb4(%15: i1):  // 2 preds: ^bb2, ^bb3
    "llvm.cond_br"(%15)[^bb1, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.return"(%10) : (i32) -> ()
  }) : () -> ()
