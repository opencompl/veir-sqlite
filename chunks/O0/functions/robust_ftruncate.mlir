"builtin.module"() ({
  ...
  ^bb0(%arg0: i32, %arg1: i64):
    %0 = "llvm.mlir.constant"() <{value = 152 : i64}> : () -> i64
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb4
    ...
    %7 = "llvm.call"(%6, %arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i64) -> i32
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // pred: ^bb1
    %8 = "llvm.icmp"(%7, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%8, %4)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    %9 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @__error, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>}> : () -> !llvm.ptr
    %10 = "llvm.load"(%9) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %11 = "llvm.icmp"(%10, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%11)[^bb4] : (i1) -> ()
  ^bb4(%12: i1):  // 2 preds: ^bb2, ^bb3
    "llvm.cond_br"(%12)[^bb1, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.return"(%7) : (i32) -> ()
  }) : () -> ()
