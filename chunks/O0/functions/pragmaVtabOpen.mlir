"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %6 = "llvm.call"(%0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3_malloc, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb0
    ...
    %8 = "llvm.getelementptr"(%6, %4) <{elem_type = !llvm.struct<"struct.PragmaVtabCursor", (struct<"struct.sqlite3_vtab_cursor", (ptr)>, ptr, i64, array<2 x ptr>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %9 = "llvm.getelementptr"(%8, %4) <{elem_type = !llvm.struct<"struct.sqlite3_vtab_cursor", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg0, %9) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %10 = "llvm.getelementptr"(%6, %4) <{elem_type = !llvm.struct<"struct.PragmaVtabCursor", (struct<"struct.sqlite3_vtab_cursor", (ptr)>, ptr, i64, array<2 x ptr>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
