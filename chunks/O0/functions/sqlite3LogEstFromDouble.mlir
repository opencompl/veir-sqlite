"builtin.module"() ({
  ...
  ^bb0(%arg0: f64):
    ...
    %1 = "llvm.mlir.constant"() <{value = 2.000000e+09 : f64}> : () -> f64
    %2 = "llvm.mlir.constant"() <{value = 52 : i64}> : () -> i64
    %3 = "llvm.mlir.constant"() <{value = 1022 : i64}> : () -> i64
    %4 = "llvm.mlir.constant"() <{value = 10 : i32}> : () -> i32
    %5 = "llvm.mlir.constant"() <{value = 0 : i16}> : () -> i16
    %6 = "llvm.fcmp"(%arg0, %0) <{fastmathFlags = #llvm.fastmath<none>, predicate = 5 : i64}> : (f64, f64) -> i1
    "llvm.cond_br"(%6)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    "llvm.br"(%5)[^bb5] : (i16) -> ()
  ^bb2:  // pred: ^bb0
    %7 = "llvm.fcmp"(%arg0, %1) <{fastmathFlags = #llvm.fastmath<none>, predicate = 5 : i64}> : (f64, f64) -> i1
    "llvm.cond_br"(%7)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %8 = "llvm.fptoui"(%arg0) : (f64) -> i64
    %9 = "llvm.call"(%8) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3LogEst, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.signext}]}> : (i64) -> i16
    "llvm.br"(%9)[^bb5] : (i16) -> ()
  ^bb4:  // pred: ^bb2
    %10 = "llvm.bitcast"(%arg0) : (f64) -> i64
    %11 = "llvm.lshr"(%10, %2) : (i64, i64) -> i64
    %12 = "llvm.sub"(%11, %3) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %13 = "llvm.trunc"(%12) <{overflowFlags = 0 : i32}> : (i64) -> i16
    %14 = "llvm.sext"(%13) : (i16) -> i32
    %15 = "llvm.mul"(%14, %4) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %16 = "llvm.trunc"(%15) <{overflowFlags = 0 : i32}> : (i32) -> i16
    "llvm.br"(%16)[^bb5] : (i16) -> ()
  ^bb5(%17: i16):  // 3 preds: ^bb1, ^bb3, ^bb4
    "llvm.return"(%17) : (i16) -> ()
  }) : () -> ()
