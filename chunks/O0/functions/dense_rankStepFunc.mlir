"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %7 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.CallCount", (i64, i64, i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
