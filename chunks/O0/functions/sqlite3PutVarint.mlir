"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64):
    ...
    %1 = "llvm.mlir.constant"() <{value = 16383 : i64}> : () -> i64
    ...
    %8 = "llvm.icmp"(%arg1, %0) <{predicate = 7 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%8)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %9 = "llvm.and"(%arg1, %0) : (i64, i64) -> i64
    %10 = "llvm.trunc"(%9) <{overflowFlags = 0 : i32}> : (i64) -> i8
    ...
    "llvm.store"(%10, %11) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.br"(%7)[^bb5] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %12 = "llvm.icmp"(%arg1, %1) <{predicate = 7 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%12)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %13 = "llvm.lshr"(%arg1, %2) : (i64, i64) -> i64
    %14 = "llvm.and"(%13, %0) : (i64, i64) -> i64
    %15 = "llvm.or"(%14, %3) : (i64, i64) -> i64
    %16 = "llvm.trunc"(%15) <{overflowFlags = 0 : i32}> : (i64) -> i8
    ...
    %18 = "llvm.and"(%arg1, %0) : (i64, i64) -> i64
    %19 = "llvm.trunc"(%18) <{overflowFlags = 0 : i32}> : (i64) -> i8
    ...
    "llvm.store"(%19, %20) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.br"(%6)[^bb5] : (i32) -> ()
  ^bb4:  // pred: ^bb2
    %21 = "llvm.call"(%arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @putVarint64, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> i32
    "llvm.br"(%21)[^bb5] : (i32) -> ()
  ^bb5(%22: i32):  // 3 preds: ^bb1, ^bb3, ^bb4
    "llvm.return"(%22) : (i32) -> ()
  }) : () -> ()
