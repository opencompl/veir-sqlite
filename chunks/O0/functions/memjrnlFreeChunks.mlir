"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    %4 = "llvm.getelementptr"(%2, %1) <{elem_type = !llvm.struct<"struct.FileChunk", (ptr, array<8 x i8>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
