"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    %40 = "llvm.getelementptr"(%7, %4, %39) <{elem_type = !llvm.array<274 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %44 = "llvm.getelementptr"(%33, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb38:  // pred: ^bb37
    ...
    %92 = "llvm.getelementptr"(%21, %4, %91) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb39:  // pred: ^bb38
    ...
    "llvm.br"()[^bb41] : () -> ()
  ^bb40:  // pred: ^bb38
    %98 = "llvm.getelementptr"(%85, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb46:  // 2 preds: ^bb44, ^bb45
    ...
    %106 = "llvm.getelementptr"(%arg1, %1) <{elem_type = !llvm.struct<"struct.Column", (ptr, i8, i8, i8, i8, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
