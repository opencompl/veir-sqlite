"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %7 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.array<40 x ptr>}> : (i32) -> !llvm.ptr
    ...
    "llvm.intr.memset"(%8, %2, %3) <{arg_attrs = [{llvm.align = 16 : i64}, {}, {}], isVolatile = false}> : (!llvm.ptr, i8, i64) -> ()
  ...
  ^bb2:  // pred: ^bb1
    %11 = "llvm.getelementptr"(%9, %6) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %12 = "llvm.load"(%11) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %13 = "llvm.getelementptr"(%9, %6) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb3(%14: i32, %15: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    ...
    %17 = "llvm.getelementptr"(%7, %1, %16) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    ...
    %21 = "llvm.getelementptr"(%7, %1, %20) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %25 = "llvm.getelementptr"(%7, %1, %24) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb3
    ...
    %28 = "llvm.getelementptr"(%7, %1, %27) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb7:  // pred: ^bb1
    ...
    %30 = "llvm.load"(%29) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
  ...
  ^bb9:  // pred: ^bb8
    ...
    %36 = "llvm.getelementptr"(%7, %1, %35) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb12:  // pred: ^bb11
    ...
    %41 = "llvm.getelementptr"(%7, %1, %40) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb13:  // pred: ^bb11
    ...
    %45 = "llvm.getelementptr"(%7, %1, %44) <{elem_type = !llvm.array<40 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
