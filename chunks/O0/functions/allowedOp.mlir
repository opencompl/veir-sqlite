"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    %8 = "llvm.icmp"(%arg0, %0) <{predicate = 4 : i64}> : (i32, i32) -> i1
  ...
  ^bb3:  // pred: ^bb2
    "llvm.br"(%6)[^bb8] : (i32) -> ()
  ^bb4:  // pred: ^bb2
    %10 = "llvm.icmp"(%arg0, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%10, %3)[^bb7, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb5:  // pred: ^bb4
    %11 = "llvm.icmp"(%arg0, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%11, %3)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb5
    %12 = "llvm.icmp"(%arg0, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%12)[^bb7] : (i1) -> ()
  ^bb7(%13: i1):  // 3 preds: ^bb4, ^bb5, ^bb6
    %14 = "llvm.zext"(%13) : (i1) -> i32
    "llvm.br"(%14)[^bb8] : (i32) -> ()
  ^bb8(%15: i32):  // 3 preds: ^bb1, ^bb3, ^bb7
    "llvm.return"(%15) : (i32) -> ()
  }) : () -> ()
