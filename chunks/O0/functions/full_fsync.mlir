"builtin.module"() ({
  ...
  ^bb0(%arg0: i32, %arg1: i32, %arg2: i32):
    ...
    %2 = "llvm.mlir.constant"() <{value = 176 : i64}> : () -> i64
  ...
  ^bb1:  // pred: ^bb0
    ...
    %8 = "llvm.call"(%7, %arg0, %5, %0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>, var_callee_type = !llvm.func<i32 (i32, i32, ...)>}> : (!llvm.ptr, i32, i32, i32) -> i32
    "llvm.br"(%8)[^bb3] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    "llvm.br"(%1)[^bb3] : (i32) -> ()
  ^bb3(%9: i32):  // 2 preds: ^bb1, ^bb2
    %10 = "llvm.icmp"(%9, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%10, %9)[^bb4, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %11 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @"\01_fsync", fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i32) -> i32
    "llvm.br"(%11)[^bb5] : (i32) -> ()
  ^bb5(%12: i32):  // 2 preds: ^bb3, ^bb4
    "llvm.return"(%12) : (i32) -> ()
  }) : () -> ()
