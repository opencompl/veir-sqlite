"builtin.module"() ({
  ...
  ^bb1(%8: i64, %9: i32):  // 2 preds: ^bb0, ^bb5
    ...
    %14 = "llvm.getelementptr"(%2, %0, %13) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
