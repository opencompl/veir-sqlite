"builtin.module"() ({
  ...
  ^bb0(%arg0: i8):
    ...
    %5 = "llvm.getelementptr"(%0, %1, %4) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
