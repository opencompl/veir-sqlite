"builtin.module"() ({
  ...
  ^bb1(%7: !llvm.ptr, %8: !llvm.ptr, %9: !llvm.ptr):  // 2 preds: ^bb0, ^bb8
    %10 = "llvm.getelementptr"(%arg0, %2) <{elem_type = !llvm.struct<"struct.SortSubtask", (ptr, i32, i32, ptr, ptr, struct<"struct.SorterList", (ptr, ptr, i64)>, ptr, struct<"struct.SorterFile", (ptr, i64)>, struct<"struct.SorterFile", (ptr, i64)>, i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %13 = "llvm.getelementptr"(%9, %2) <{elem_type = !llvm.struct<"struct.SorterRecord", (i32, struct<"union.anon.25", (ptr)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %16 = "llvm.getelementptr"(%7, %2) <{elem_type = !llvm.struct<"struct.SorterRecord", (i32, struct<"union.anon.25", (ptr)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    ...
    %20 = "llvm.getelementptr"(%9, %2) <{elem_type = !llvm.struct<"struct.SorterRecord", (i32, struct<"union.anon.25", (ptr)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %21 = "llvm.getelementptr"(%9, %2) <{elem_type = !llvm.struct<"struct.SorterRecord", (i32, struct<"union.anon.25", (ptr)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb1
    ...
    %24 = "llvm.getelementptr"(%7, %2) <{elem_type = !llvm.struct<"struct.SorterRecord", (i32, struct<"union.anon.25", (ptr)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %25 = "llvm.getelementptr"(%7, %2) <{elem_type = !llvm.struct<"struct.SorterRecord", (i32, struct<"union.anon.25", (ptr)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
