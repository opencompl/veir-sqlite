"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    %9 = "llvm.getelementptr"(%1, %2, %8) <{elem_type = !llvm.array<128 x i8>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
