"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: !llvm.ptr, %arg3: i32):
    ...
    %6 = "llvm.getelementptr"(%5, %0) <{elem_type = !llvm.struct<"struct.unix_syscall", (ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb1(%9: i64, %10: !llvm.ptr, %11: i32, %12: i32):  // 2 preds: ^bb0, ^bb11
    %13 = "llvm.load"(%6) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %14 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.unixFile", (ptr, ptr, ptr, i32, i8, i16, i32, ptr, ptr, ptr, ptr, i32, i32, i64, i64, i64, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %15 = "llvm.load"(%14) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %16 = "llvm.sext"(%11) : (i32) -> i64
    %17 = "llvm.call"(%13, %15, %10, %16, %9) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, i32, !llvm.ptr, i64, i64) -> i64
    %18 = "llvm.trunc"(%17) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %19 = "llvm.icmp"(%18, %11) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%19)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.br"(%18, %12)[^bb12] : (i32, i32) -> ()
  ^bb3:  // pred: ^bb1
    %20 = "llvm.icmp"(%18, %0) <{predicate = 2 : i64}> : (i32, i32) -> i1
  ...
  ^bb4:  // pred: ^bb3
    ...
    %23 = "llvm.icmp"(%22, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%23)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.br"(%9, %10, %11, %1, %12)[^bb11] : (i64, !llvm.ptr, i32, i32, i32) -> ()
  ^bb6:  // pred: ^bb4
    %24 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @__errno_location, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = none, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>, will_return}> : () -> !llvm.ptr
    %25 = "llvm.load"(%24) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.call"(%arg0, %25) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @storeLastErrno, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i32) -> ()
    "llvm.br"(%18, %0)[^bb12] : (i32, i32) -> ()
  ^bb7:  // pred: ^bb3
    %26 = "llvm.icmp"(%18, %0) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%26, %9, %10, %11, %12)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 4>}> : (i1, i64, !llvm.ptr, i32, i32) -> ()
  ^bb8:  // pred: ^bb7
    %27 = "llvm.sub"(%11, %18) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %28 = "llvm.sext"(%18) : (i32) -> i64
    %29 = "llvm.add"(%9, %28) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %30 = "llvm.add"(%12, %18) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %31 = "llvm.sext"(%18) : (i32) -> i64
    %32 = "llvm.getelementptr"(%10, %31) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%29, %32, %27, %30)[^bb9] : (i64, !llvm.ptr, i32, i32) -> ()
  ^bb9(%33: i64, %34: !llvm.ptr, %35: i32, %36: i32):  // 2 preds: ^bb7, ^bb8
    "llvm.br"()[^bb10] : () -> ()
  ^bb10:  // pred: ^bb9
    "llvm.br"(%33, %34, %35, %18, %36)[^bb11] : (i64, !llvm.ptr, i32, i32, i32) -> ()
  ^bb11(%37: i64, %38: !llvm.ptr, %39: i32, %40: i32, %41: i32):  // 2 preds: ^bb5, ^bb10
    %42 = "llvm.icmp"(%40, %0) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%42, %37, %38, %39, %41, %40, %41)[^bb1, ^bb12] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 4, 2>}> : (i1, i64, !llvm.ptr, i32, i32, i32, i32) -> ()
  ^bb12(%43: i32, %44: i32):  // 3 preds: ^bb2, ^bb6, ^bb11
    %45 = "llvm.add"(%43, %44) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.return"(%45) : (i32) -> ()
  }) : () -> ()
