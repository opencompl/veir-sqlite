"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32, %arg3: !llvm.ptr):
    ...
    %11 = "llvm.mlir.constant"() <{value = 4096 : i64}> : () -> i64
    ...
    %17 = "llvm.mlir.addressof"() <{global_name = @".str.53"}> : () -> !llvm.ptr
    %18 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
    %19 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.array<4098 x i8>}> : (i32) -> !llvm.ptr
    %20 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%1, %20) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %21 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%1, %21) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %22 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%1, %22) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %23 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg2, %23) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %24 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    ...
    %30 = "llvm.getelementptr"(%19, %5, %5) <{elem_type = !llvm.array<4098 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.br"(%34)[^bb10] : (i32) -> ()
  ^bb3:  // pred: ^bb1
    %35 = "llvm.getelementptr"(%19, %5, %5) <{elem_type = !llvm.array<4098 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb4:  // 2 preds: ^bb0, ^bb3
    ...
    %36 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %40 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    %43 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // 2 preds: ^bb4, ^bb5
    ...
    "llvm.br"(%46)[^bb10] : (i32) -> ()
  ^bb7:  // pred: ^bb5
    %47 = "llvm.getelementptr"(%18, %1) <{elem_type = !llvm.struct<"struct.DbPath", (i32, i32, ptr, i32, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
