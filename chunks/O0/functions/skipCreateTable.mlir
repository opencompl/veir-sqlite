"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %5 = "llvm.mlir.constant"() <{value = 123047 : i32}> : () -> i32
  ...
  ^bb3(%8: i32):  // 2 preds: ^bb2, ^bb7
    ...
    %10 = "llvm.getelementptr"(%arg1, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %11 = "llvm.call"(%10, %6) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3GetToken, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i64
    %12 = "llvm.sext"(%8) : (i32) -> i64
    %13 = "llvm.add"(%12, %11) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb6:  // pred: ^bb5
    ...
    "llvm.call"(%arg0, %19) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3_result_error_code, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i32) -> ()
    "llvm.br"(%0)[^bb9] : (i32) -> ()
  ^bb7:  // pred: ^bb5
    "llvm.br"(%14)[^bb3] : (i32) -> ()
  ^bb8:  // pred: ^bb4
    ...
    "llvm.br"(%2)[^bb9] : (i32) -> ()
  ^bb9(%20: i32):  // 3 preds: ^bb1, ^bb6, ^bb8
    "llvm.return"(%20) : (i32) -> ()
  }) : () -> ()
