"builtin.module"() ({
  ...
  ^bb3:  // pred: ^bb2
    %13 = "llvm.getelementptr"(%6, %1) <{elem_type = !llvm.struct<"struct.CountCtx", (i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
