"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %7 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.LastValueCtx", (ptr, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %12 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.LastValueCtx", (ptr, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%11, %12) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %13 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.LastValueCtx", (ptr, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.br"()[^bb4] : () -> ()
  ^bb3:  // pred: ^bb1
    %16 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.LastValueCtx", (ptr, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
