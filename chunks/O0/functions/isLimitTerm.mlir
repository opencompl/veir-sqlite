"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %5 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereTerm", (ptr, ptr, i16, i16, i16, i8, i8, i32, i32, struct<"union.anon.18", (ptr)>, i64, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %6 = "llvm.load"(%5) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %7 = "llvm.zext"(%6) : (i8) -> i32
    %8 = "llvm.icmp"(%7, %2) <{predicate = 5 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%8, %3)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    %9 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereTerm", (ptr, ptr, i16, i16, i16, i8, i8, i32, i32, struct<"union.anon.18", (ptr)>, i64, i64)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %10 = "llvm.load"(%9) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %11 = "llvm.zext"(%10) : (i8) -> i32
    %12 = "llvm.icmp"(%11, %4) <{predicate = 3 : i64}> : (i32, i32) -> i1
    "llvm.br"(%12)[^bb2] : (i1) -> ()
