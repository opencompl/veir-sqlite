"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.noundef}], dso_local, frame_pointer = #llvm.framePointerKind<all>, function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<external>, no_inline, no_unwind, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "vdbeIncrSwap", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 0 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %10 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    %13 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %21 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    %26 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %28 = "llvm.getelementptr"(%27, %1) <{elem_type = !llvm.struct<"struct.SorterFile", (ptr, i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %29 = "llvm.load"(%28) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %30 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    %33 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb9:  // pred: ^bb0
    ...
    %38 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %40 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %42 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %46 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb10:  // pred: ^bb9
    %49 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.IncrMerger", (ptr, ptr, i64, i32, i32, i32, array<2 x struct<"struct.SorterFile", (ptr, i64)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.noundef}], dso_local, frame_pointer = #llvm.framePointerKind<all>, function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<external>, no_inline, no_unwind, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "vdbeIncrBgPopulate", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 0 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  }) : () -> ()
