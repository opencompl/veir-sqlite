"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: i32, %arg3: !llvm.ptr, %arg4: i32, %arg5: i32):
    ...
    %1 = "llvm.icmp"(%arg2, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%1)[^bb1, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %2 = "llvm.icmp"(%arg5, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%2)[^bb2, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %3 = "llvm.icmp"(%arg1, %arg4) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%3)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    "llvm.br"(%0)[^bb6] : (i32) -> ()
  ^bb4:  // pred: ^bb2
    %4 = "llvm.zext"(%arg1) : (i32) -> i64
    %5 = "llvm.call"(%arg0, %arg3, %4) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %6 = "llvm.icmp"(%5, %0) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %7 = "llvm.zext"(%6) : (i1) -> i32
    "llvm.br"(%7)[^bb6] : (i32) -> ()
  ^bb5:  // 2 preds: ^bb0, ^bb1
    %8 = "llvm.call"(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @jsonLabelCompareEscaped, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 6, 0>}> : (!llvm.ptr, i32, i32, !llvm.ptr, i32, i32) -> i32
    "llvm.br"(%8)[^bb6] : (i32) -> ()
  ^bb6(%9: i32):  // 3 preds: ^bb3, ^bb4, ^bb5
    "llvm.return"(%9) : (i32) -> ()
  }) : () -> ()
