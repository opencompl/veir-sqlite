"builtin.module"() ({
  ...
  ^bb10:  // pred: ^bb9
    ...
    %41 = "llvm.getelementptr"(%37, %1) <{elem_type = !llvm.struct<"struct.PgFreeslot", (ptr)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
