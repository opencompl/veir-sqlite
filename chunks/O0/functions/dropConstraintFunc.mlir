"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: !llvm.ptr):
    ...
    %8 = "llvm.mlir.addressof"() <{global_name = @".str.926"}> : () -> !llvm.ptr
    %9 = "llvm.mlir.constant"() <{value = 44 : i32}> : () -> i32
    %10 = "llvm.mlir.addressof"() <{global_name = @".str.4"}> : () -> !llvm.ptr
    %11 = "llvm.mlir.addressof"() <{global_name = @".str.1216"}> : () -> !llvm.ptr
    ...
    %15 = "llvm.mlir.addressof"() <{global_name = @".str.1215"}> : () -> !llvm.ptr
    ...
    %24 = "llvm.mlir.addressof"() <{global_name = @".str.1214"}> : () -> !llvm.ptr
