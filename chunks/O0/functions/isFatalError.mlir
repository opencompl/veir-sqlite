"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    "llvm.cond_br"(%4, %1)[^bb1, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    %5 = "llvm.icmp"(%arg0, %2) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%5, %1)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %6 = "llvm.icmp"(%arg0, %3) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.br"(%6)[^bb3] : (i1) -> ()
  ^bb3(%7: i1):  // 3 preds: ^bb0, ^bb1, ^bb2
