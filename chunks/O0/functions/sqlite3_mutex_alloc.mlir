"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    %6 = "llvm.icmp"(%arg0, %0) <{predicate = 3 : i64}> : (i32, i32) -> i1
  ...
  ^bb3:  // 2 preds: ^bb0, ^bb1
    %9 = "llvm.icmp"(%arg0, %0) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%9)[^bb4, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb4:  // pred: ^bb3
    %10 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @sqlite3MutexInit, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>}> : () -> i32
  ...
  ^bb7(%14: !llvm.ptr):  // 3 preds: ^bb2, ^bb5, ^bb6
