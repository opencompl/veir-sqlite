"builtin.module"() ({
  ...
  ^bb3:  // pred: ^bb2
    %12 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    %15 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    %18 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %21 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb7:  // 3 preds: ^bb2, ^bb5, ^bb6
    %26 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb8:  // pred: ^bb7
    %29 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %30 = "llvm.load"(%29) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %31 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // 2 preds: ^bb7, ^bb8
    %33 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb10:  // 3 preds: ^bb3, ^bb4, ^bb6
    %35 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.AuxData", (i32, i32, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
