"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %5 = "llvm.getelementptr"(%3, %0) <{elem_type = !llvm.struct<"struct.CountCtx", (i64)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %6 = "llvm.load"(%5) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    "llvm.br"(%6)[^bb3] : (i64) -> ()
  ^bb2:  // pred: ^bb0
    "llvm.br"(%2)[^bb3] : (i64) -> ()
  ^bb3(%7: i64):  // 2 preds: ^bb1, ^bb2
