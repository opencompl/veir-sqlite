"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    "llvm.br"(%2)[^bb3] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %4 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @strlen, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i64
    %5 = "llvm.trunc"(%4) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %6 = "llvm.and"(%1, %5) : (i32, i32) -> i32
    "llvm.br"(%6)[^bb3] : (i32) -> ()
