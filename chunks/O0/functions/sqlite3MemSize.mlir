"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %2 = "llvm.getelementptr"(%arg0, %0) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %3 = "llvm.getelementptr"(%2, %1) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
