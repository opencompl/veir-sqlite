"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    "llvm.br"(%8)[^bb14] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %10 = "llvm.call"(%1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3MutexAlloc, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i32) -> !llvm.ptr
  ...
  ^bb3(%11: i32):  // 2 preds: ^bb2, ^bb7
    %12 = "llvm.load"(%2) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %13 = "llvm.icmp"(%11, %12) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb4:  // pred: ^bb3
    ...
    %15 = "llvm.zext"(%11) : (i32) -> i64
    %16 = "llvm.getelementptr"(%14, %15) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb4
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // pred: ^bb6
    %19 = "llvm.add"(%11, %3) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.br"(%19)[^bb3] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32) -> ()
  ^bb8:  // 2 preds: ^bb3, ^bb5
    %20 = "llvm.load"(%2) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %21 = "llvm.icmp"(%11, %20) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%21, %8)[^bb9, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb9:  // pred: ^bb8
    %22 = "llvm.load"(%2) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %23 = "llvm.add"(%22, %3) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %24 = "llvm.zext"(%23) : (i32) -> i64
    %25 = "llvm.mul"(%24, %5) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %26 = "llvm.load"(%4) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %27 = "llvm.call"(%26, %25) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @sqlite3_realloc64, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %28 = "llvm.icmp"(%27, %6) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%28)[^bb10, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:  // pred: ^bb9
    "llvm.br"(%7)[^bb12] : (i32) -> ()
  ^bb11:  // pred: ^bb9
    "llvm.store"(%27, %4) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %29 = "llvm.load"(%4) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    ...
    %33 = "llvm.load"(%2) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %34 = "llvm.add"(%33, %3) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.store"(%34, %2) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"(%8)[^bb12] : (i32) -> ()
