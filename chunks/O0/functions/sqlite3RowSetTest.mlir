"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: i64):
    ...
    %11 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 8>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    %14 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %18 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 7>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4(%24: !llvm.ptr):  // 2 preds: ^bb2, ^bb3
    %25 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %31 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %32 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb7:  // pred: ^bb6
    ...
    %36 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%35, %36) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"(%31)[^bb11] : (!llvm.ptr) -> ()
  ^bb8:  // pred: ^bb6
    %37 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %39 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb9:  // pred: ^bb8
    "llvm.br"()[^bb10] : () -> ()
  ^bb10:  // pred: ^bb9
    %42 = "llvm.getelementptr"(%28, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb13:  // pred: ^bb12
    %48 = "llvm.getelementptr"(%46, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%7, %48) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %49 = "llvm.getelementptr"(%46, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %51 = "llvm.getelementptr"(%46, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%50, %51) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"()[^bb14] : () -> ()
  ^bb14:  // 2 preds: ^bb12, ^bb13
    "llvm.br"()[^bb15] : () -> ()
  ^bb15:  // 2 preds: ^bb11, ^bb14
    %52 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%4, %52) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %53 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%4, %53) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %54 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 7>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb16:  // 2 preds: ^bb1, ^bb15
    %59 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 8>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg1, %59) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb17] : () -> ()
  ^bb17:  // 2 preds: ^bb0, ^bb16
    %60 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.RowSet", (ptr, ptr, ptr, ptr, ptr, ptr, i16, i16, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb19:  // pred: ^bb18
    %64 = "llvm.getelementptr"(%62, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb21:  // pred: ^bb20
    %68 = "llvm.getelementptr"(%66, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb22:  // pred: ^bb21
    %71 = "llvm.getelementptr"(%66, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %72 = "llvm.load"(%71) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%72)[^bb27] : (!llvm.ptr) -> ()
  ^bb23:  // pred: ^bb21
    %73 = "llvm.getelementptr"(%66, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb24:  // pred: ^bb23
    %76 = "llvm.getelementptr"(%66, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb28:  // pred: ^bb20
    "llvm.br"()[^bb29] : () -> ()
  ^bb29:  // pred: ^bb28
    %79 = "llvm.getelementptr"(%62, %1) <{elem_type = !llvm.struct<"struct.RowSetEntry", (i64, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
