"builtin.module"() ({
  ...
  ^bb11:  // pred: ^bb10
    ...
    %50 = "llvm.getelementptr"(%6, %7, %49) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb45(%113: i32):  // 2 preds: ^bb44, ^bb48
    ...
    %118 = "llvm.getelementptr"(%6, %7, %117) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
