"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    %22 = "llvm.getelementptr"(%2, %3, %21) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb7:  // 2 preds: ^bb1, ^bb4
    ...
    %36 = "llvm.getelementptr"(%2, %3, %35) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
