"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %7 = "llvm.mlir.addressof"() <{global_name = @sqlite3Apis}> : () -> !llvm.ptr
    %8 = "llvm.mlir.addressof"() <{global_name = @".str.1408"}> : () -> !llvm.ptr
  ...
  ^bb3(%12: i32, %13: i32):  // 2 preds: ^bb2, ^bb11
    %14 = "llvm.icmp"(%12, %2) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%14)[^bb4, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5:  // pred: ^bb4
    "llvm.br"(%6, %2)[^bb7] : (!llvm.ptr, i32) -> ()
  ^bb6:  // pred: ^bb4
    %18 = "llvm.load"(%5) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %19 = "llvm.zext"(%13) : (i32) -> i64
    %20 = "llvm.getelementptr"(%18, %19) <{elem_type = !llvm.ptr, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %21 = "llvm.load"(%20) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%21, %12)[^bb7] : (!llvm.ptr, i32) -> ()
  ^bb7(%22: !llvm.ptr, %23: i32):  // 2 preds: ^bb5, ^bb6
    ...
    "llvm.cond_br"(%24, %23)[^bb8, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb8:  // pred: ^bb7
    %25 = "llvm.call"(%22, %arg0, %9, %7) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %26 = "llvm.icmp"(%25, %2) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%26, %23)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb9:  // pred: ^bb8
    %27 = "llvm.load"(%9) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.call"(%arg0, %25, %8, %27) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @sqlite3ErrorWithMsg, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>, var_callee_type = !llvm.func<void (ptr, i32, ptr, ...)>}> : (!llvm.ptr, i32, !llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"(%2)[^bb10] : (i32) -> ()
  ^bb10(%28: i32):  // 3 preds: ^bb7, ^bb8, ^bb9
    ...
    "llvm.br"()[^bb11] : () -> ()
  ^bb11:  // pred: ^bb10
    %30 = "llvm.add"(%13, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.br"(%28, %30)[^bb3] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32, i32) -> ()
