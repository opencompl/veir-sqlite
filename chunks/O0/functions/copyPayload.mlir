"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32, %arg3: i32, %arg4: !llvm.ptr):
    ...
    %1 = "llvm.icmp"(%arg3, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%1)[^bb1, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %2 = "llvm.call"(%arg4) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3PagerWrite, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i32
    %3 = "llvm.icmp"(%2, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%3)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.br"(%2)[^bb6] : (i32) -> ()
  ^bb3:  // pred: ^bb1
    %4 = "llvm.sext"(%arg2) : (i32) -> i64
    "llvm.intr.memcpy"(%arg0, %arg1, %4) <{arg_attrs = [{llvm.align = 1 : i64}, {llvm.align = 1 : i64}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    "llvm.br"()[^bb5] : () -> ()
  ^bb4:  // pred: ^bb0
    %5 = "llvm.sext"(%arg2) : (i32) -> i64
    "llvm.intr.memcpy"(%arg1, %arg0, %5) <{arg_attrs = [{llvm.align = 1 : i64}, {llvm.align = 1 : i64}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    "llvm.br"()[^bb5] : () -> ()
  ^bb5:  // 2 preds: ^bb3, ^bb4
    "llvm.br"(%0)[^bb6] : (i32) -> ()
  ^bb6(%6: i32):  // 2 preds: ^bb2, ^bb5
    "llvm.return"(%6) : (i32) -> ()
  }) : () -> ()
