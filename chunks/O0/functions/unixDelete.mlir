"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32):
    ...
    %19 = "llvm.load"(%3) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %20 = "llvm.call"(%19, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i32
  ...
  ^bb1:  // pred: ^bb0
    ...
    %24 = "llvm.icmp"(%23, %13) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%24)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.br"(%17)[^bb4] : (i32) -> ()
  ^bb3:  // pred: ^bb1
    %25 = "llvm.call"(%14, %15, %arg1, %16) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @unixLogErrorAtLine, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (i32, !llvm.ptr, !llvm.ptr, i32) -> i32
    "llvm.br"(%25)[^bb4] : (i32) -> ()
  ^bb4(%26: i32):  // 2 preds: ^bb2, ^bb3
    "llvm.br"(%26)[^bb13] : (i32) -> ()
  ^bb5:  // pred: ^bb0
    %27 = "llvm.and"(%arg2, %0) : (i32, i32) -> i32
    %28 = "llvm.icmp"(%27, %5) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%28, %5)[^bb6, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
    %29 = "llvm.load"(%7) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %30 = "llvm.call"(%29, %arg1, %18) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
  ...
  ^bb7:  // pred: ^bb6
    ...
    %33 = "llvm.call"(%32, %5, %5) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @full_fsync, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (i32, i32, i32) -> i32
    %34 = "llvm.icmp"(%33, %5) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%34, %30)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb8:  // pred: ^bb7
    %35 = "llvm.call"(%8, %9, %arg1, %10) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @unixLogErrorAtLine, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (i32, !llvm.ptr, !llvm.ptr, i32) -> i32
    "llvm.br"(%35)[^bb9] : (i32) -> ()
  ^bb9(%36: i32):  // 2 preds: ^bb7, ^bb8
    %37 = "llvm.load"(%18) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.call"(%11, %37, %12) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @robust_close, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i32) -> ()
    "llvm.br"(%36)[^bb11] : (i32) -> ()
  ^bb10:  // pred: ^bb6
    "llvm.br"(%5)[^bb11] : (i32) -> ()
  ^bb11(%38: i32):  // 2 preds: ^bb9, ^bb10
    "llvm.br"(%38)[^bb12] : (i32) -> ()
  ^bb12(%39: i32):  // 2 preds: ^bb5, ^bb11
    "llvm.br"(%39)[^bb13] : (i32) -> ()
  ^bb13(%40: i32):  // 2 preds: ^bb4, ^bb12
    "llvm.return"(%40) : (i32) -> ()
  }) : () -> ()
