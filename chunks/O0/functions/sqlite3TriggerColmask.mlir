"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i32, %arg4: i32, %arg5: !llvm.ptr, %arg6: i32):
    ...
    %16 = "llvm.getelementptr"(%arg5, %3) <{elem_type = !llvm.struct<"struct.Table", (ptr, ptr, ptr, ptr, ptr, i32, i32, i32, i16, i16, i16, i16, i16, i8, i8, struct<"union.anon.14", (struct<"struct.anon.15", (i32, ptr, ptr)>)>, ptr, ptr, array<16 x i8>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 14>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    %23 = "llvm.getelementptr"(%21, %3) <{elem_type = !llvm.struct<"struct.Trigger", (ptr, ptr, i8, i8, i8, ptr, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    %27 = "llvm.getelementptr"(%21, %3) <{elem_type = !llvm.struct<"struct.Trigger", (ptr, ptr, i8, i8, i8, ptr, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %32 = "llvm.getelementptr"(%21, %3) <{elem_type = !llvm.struct<"struct.Trigger", (ptr, ptr, i8, i8, i8, ptr, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 6>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb7:  // pred: ^bb6
    %36 = "llvm.getelementptr"(%21, %3) <{elem_type = !llvm.struct<"struct.Trigger", (ptr, ptr, i8, i8, i8, ptr, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb10:  // pred: ^bb9
    %41 = "llvm.getelementptr"(%39, %3) <{elem_type = !llvm.struct<"struct.TriggerPrg", (ptr, ptr, ptr, i32, array<2 x i32>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb13(%48: i32):  // 4 preds: ^bb4, ^bb5, ^bb6, ^bb12
    "llvm.br"()[^bb14] : () -> ()
  ^bb14:  // pred: ^bb13
    %49 = "llvm.getelementptr"(%21, %3) <{elem_type = !llvm.struct<"struct.Trigger", (ptr, ptr, i8, i8, i8, ptr, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 10>}> : (!llvm.ptr, i32) -> !llvm.ptr
