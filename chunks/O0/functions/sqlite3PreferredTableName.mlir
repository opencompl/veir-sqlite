"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %5 = "llvm.mlir.addressof"() <{global_name = @".str.348"}> : () -> !llvm.ptr
    ...
    %7 = "llvm.mlir.addressof"() <{global_name = @".str.371"}> : () -> !llvm.ptr
    ...
    %9 = "llvm.mlir.addressof"() <{global_name = @".str.728"}> : () -> !llvm.ptr
    %10 = "llvm.mlir.addressof"() <{global_name = @".str.729"}> : () -> !llvm.ptr
