"builtin.module"() ({
  ...
  ^bb1(%3: i32):  // 2 preds: ^bb0, ^bb5
    %4 = "llvm.icmp"(%3, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%4)[^bb2, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
  ...
  ^bb4:  // pred: ^bb2
    "llvm.br"()[^bb5] : () -> ()
  ^bb5:  // pred: ^bb4
    %9 = "llvm.add"(%3, %1) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
