"builtin.module"() ({
  ...
  ^bb0(%arg0: i64):
    ...
    %3 = "llvm.getelementptr"(%1, %0) <{elem_type = !llvm.struct<"struct.Mem0Global", (ptr, i64, i64, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %4 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
    %5 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %6 = "llvm.getelementptr"(%1, %0) <{elem_type = !llvm.struct<"struct.Mem0Global", (ptr, i64, i64, i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
