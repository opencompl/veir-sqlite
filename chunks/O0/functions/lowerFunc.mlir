"builtin.module"() ({
  ...
  ^bb4:  // pred: ^bb3
    ...
    %24 = "llvm.getelementptr"(%5, %0, %23) <{elem_type = !llvm.array<274 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
