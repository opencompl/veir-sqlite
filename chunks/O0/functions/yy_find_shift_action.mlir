"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.struct<packed (array<102 x i16>, array<85 x i16>)>, linkage = #llvm.linkage<external>, sym_name = "yyFallback", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<600 x i16>, linkage = #llvm.linkage<external>, sym_name = "yy_shift_ofst", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<2566 x i16>, linkage = #llvm.linkage<external>, sym_name = "yy_lookahead", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<2379 x i16>, linkage = #llvm.linkage<external>, sym_name = "yy_action", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<600 x i16>, linkage = #llvm.linkage<external>, sym_name = "yy_default", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  ^bb3(%13: i16):  // 2 preds: ^bb2, ^bb11
    ...
    %15 = "llvm.getelementptr"(%1, %2, %14) <{elem_type = !llvm.array<600 x i16>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    ...
    %27 = "llvm.getelementptr"(%5, %2, %26) <{elem_type = !llvm.array<187 x i16>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb9:  // 2 preds: ^bb6, ^bb7
    ...
    %45 = "llvm.getelementptr"(%8, %2, %44) <{elem_type = !llvm.array<600 x i16>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
