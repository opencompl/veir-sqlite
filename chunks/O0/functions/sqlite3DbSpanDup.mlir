"builtin.module"() ({
  ...
  ^bb1(%5: !llvm.ptr):  // 2 preds: ^bb0, ^bb2
    ...
    %9 = "llvm.getelementptr"(%1, %0, %8) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    %14 = "llvm.getelementptr"(%5, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4(%19: i32):  // 2 preds: ^bb3, ^bb5
    ...
    %25 = "llvm.getelementptr"(%1, %0, %24) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
