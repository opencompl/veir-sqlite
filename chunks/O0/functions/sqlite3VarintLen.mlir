"builtin.module"() ({
  ...
  ^bb0(%arg0: i64):
    ...
    "llvm.br"(%arg0, %0)[^bb1] : (i64, i32) -> ()
  ^bb1(%3: i64, %4: i32):  // 2 preds: ^bb0, ^bb3
    %5 = "llvm.lshr"(%3, %1) : (i64, i64) -> i64
    %6 = "llvm.icmp"(%5, %2) <{predicate = 1 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%6)[^bb2, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // pred: ^bb2
    %7 = "llvm.add"(%4, %0) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%5, %7)[^bb1] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i64, i32) -> ()
  ^bb4:  // pred: ^bb1
    "llvm.return"(%4) : (i32) -> ()
  }) : () -> ()
