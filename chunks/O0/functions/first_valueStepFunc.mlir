"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %7 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.NthValueCtx", (i64, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    ...
    %13 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.NthValueCtx", (i64, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%12, %13) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %14 = "llvm.getelementptr"(%5, %2) <{elem_type = !llvm.struct<"struct.NthValueCtx", (i64, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
