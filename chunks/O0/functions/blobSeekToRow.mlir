"builtin.module"() ({
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<29 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.467", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<5 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.468", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<8 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.469", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<20 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.470", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: !llvm.ptr):
    ...
    %17 = "llvm.mlir.addressof"() <{global_name = @".str.468"}> : () -> !llvm.ptr
    %18 = "llvm.mlir.addressof"() <{global_name = @".str.469"}> : () -> !llvm.ptr
    %19 = "llvm.mlir.addressof"() <{global_name = @".str.1"}> : () -> !llvm.ptr
    %20 = "llvm.mlir.addressof"() <{global_name = @".str.467"}> : () -> !llvm.ptr
    %21 = "llvm.mlir.addressof"() <{global_name = @".str.30"}> : () -> !llvm.ptr
    %22 = "llvm.mlir.addressof"() <{global_name = @".str.470"}> : () -> !llvm.ptr
    %23 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %24 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %25 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.Vdbe", (ptr, ptr, ptr, ptr, i16, i32, i32, i32, i32, i32, i64, i32, i64, i64, i64, i64, ptr, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr, ptr, ptr, i64, i16, i16, i8, i8, i8, i8, i16, i32, i32, array<9 x i32>, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 16>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %28 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.Vdbe", (ptr, ptr, ptr, ptr, i16, i32, i32, i32, i32, i32, i64, i32, i64, i64, i64, i64, ptr, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr, ptr, ptr, i64, i16, i16, i8, i8, i8, i8, i16, i32, i32, array<9 x i32>, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 8>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    %31 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.Vdbe", (ptr, ptr, ptr, ptr, i16, i32, i32, i32, i32, i32, i64, i32, i64, i64, i64, i64, ptr, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr, ptr, ptr, i64, i16, i16, i8, i8, i8, i8, i16, i32, i32, array<9 x i32>, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 8>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    "llvm.br"(%32)[^bb3] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %33 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    %38 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.Vdbe", (ptr, ptr, ptr, ptr, i16, i32, i32, i32, i32, i32, i64, i32, i64, i64, i64, i64, ptr, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr, ptr, ptr, i64, i16, i16, i8, i8, i8, i8, i16, i32, i32, array<9 x i32>, ptr, ptr, ptr, ptr, i32, i32, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 18>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %42 = "llvm.getelementptr"(%41, %0) <{elem_type = !llvm.struct<"struct.VdbeCursor", (i8, i8, i8, i8, i8, i8, i16, struct<"union.anon.23", (ptr)>, i64, i32, i32, ptr, struct<"union.anon.24", (ptr)>, ptr, i32, i32, i16, i16, i64, ptr, ptr, i32, i32, ptr, array<0 x i32>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 17>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %43 = "llvm.load"(%42) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %44 = "llvm.zext"(%43) : (i16) -> i32
    %45 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    %49 = "llvm.getelementptr"(%41, %0) <{elem_type = !llvm.struct<"struct.VdbeCursor", (i8, i8, i8, i8, i8, i8, i16, struct<"union.anon.23", (ptr)>, i64, i32, i32, ptr, struct<"union.anon.24", (ptr)>, ptr, i32, i32, i16, i16, i64, ptr, ptr, i32, i32, ptr, array<0 x i32>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 24>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %50 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %51 = "llvm.load"(%50) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %52 = "llvm.zext"(%51) : (i16) -> i64
    %53 = "llvm.getelementptr"(%49, %8, %52) <{elem_type = !llvm.array<0 x i32>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
  ...
  ^bb8:  // pred: ^bb7
    %57 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb11(%63: !llvm.ptr):  // 2 preds: ^bb9, ^bb10
    ...
    %65 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %68 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%6, %68) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"(%64, %13)[^bb13] : (!llvm.ptr, i32) -> ()
  ^bb12:  // pred: ^bb7
    %69 = "llvm.getelementptr"(%41, %0) <{elem_type = !llvm.struct<"struct.VdbeCursor", (i8, i8, i8, i8, i8, i8, i16, struct<"union.anon.23", (ptr)>, i64, i32, i32, ptr, struct<"union.anon.24", (ptr)>, ptr, i32, i32, i16, i16, i64, ptr, ptr, i32, i32, ptr, array<0 x i32>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 24>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %70 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %71 = "llvm.load"(%70) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %72 = "llvm.zext"(%71) : (i16) -> i32
    %73 = "llvm.getelementptr"(%41, %0) <{elem_type = !llvm.struct<"struct.VdbeCursor", (i8, i8, i8, i8, i8, i8, i16, struct<"union.anon.23", (ptr)>, i64, i32, i32, ptr, struct<"union.anon.24", (ptr)>, ptr, i32, i32, i16, i16, i64, ptr, ptr, i32, i32, ptr, array<0 x i32>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 16>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %80 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %82 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%81, %82) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %83 = "llvm.getelementptr"(%41, %0) <{elem_type = !llvm.struct<"struct.VdbeCursor", (i8, i8, i8, i8, i8, i8, i16, struct<"union.anon.23", (ptr)>, i64, i32, i32, ptr, struct<"union.anon.24", (ptr)>, ptr, i32, i32, i16, i16, i64, ptr, ptr, i32, i32, ptr, array<0 x i32>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 12>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %84 = "llvm.load"(%83) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %85 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%84, %85) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %86 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb16:  // pred: ^bb14
    %93 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb17:  // pred: ^bb16
    %96 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %99 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 4>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb18:  // pred: ^bb17
    %101 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb19:  // pred: ^bb17
    %104 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %105 = "llvm.load"(%104) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %106 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.Incrblob", (i32, i32, i16, ptr, ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 5>}> : (!llvm.ptr, i32) -> !llvm.ptr
