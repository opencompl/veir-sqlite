"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: i16, %arg3: i16):
    ...
    %7 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %8 = "llvm.load"(%7) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %9 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    ...
    %16 = "llvm.getelementptr"(%12, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    %20 = "llvm.getelementptr"(%12, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb5:  // 2 preds: ^bb2, ^bb3
    %24 = "llvm.getelementptr"(%12, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %29 = "llvm.getelementptr"(%12, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %30 = "llvm.load"(%29) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %31 = "llvm.and"(%30, %arg1) : (i64, i64) -> i64
    %32 = "llvm.getelementptr"(%12, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb9:  // pred: ^bb8
    ...
    %36 = "llvm.getelementptr"(%12, %1) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.br"(%35, %36)[^bb1] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i16, !llvm.ptr) -> ()
  ^bb10:  // pred: ^bb1
    %37 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb11:  // pred: ^bb10
    %41 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %42 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    %46 = "llvm.getelementptr"(%41, %2, %45) <{elem_type = !llvm.array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %47 = "llvm.getelementptr"(%46, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg3, %47) <{alignment = 2 : i64, ordering = 0 : i64}> : (i16, !llvm.ptr) -> ()
    "llvm.br"(%46)[^bb21] : (!llvm.ptr) -> ()
  ^bb12:  // pred: ^bb10
    %48 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb13(%50: i16, %51: !llvm.ptr):  // 2 preds: ^bb12, ^bb17
    ...
    %53 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb14:  // pred: ^bb13
    %57 = "llvm.getelementptr"(%51, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %58 = "llvm.load"(%57) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %59 = "llvm.sext"(%58) : (i16) -> i32
    %60 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %61 = "llvm.zext"(%50) : (i16) -> i64
    %62 = "llvm.getelementptr"(%60, %2, %61) <{elem_type = !llvm.array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %63 = "llvm.getelementptr"(%62, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb15:  // pred: ^bb14
    %67 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.WhereOrSet", (i16, array<3 x struct<"struct.WhereOrCost", (i64, i16, i16)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb18:  // pred: ^bb13
    %74 = "llvm.getelementptr"(%51, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb22(%80: !llvm.ptr):  // 2 preds: ^bb4, ^bb21
    %81 = "llvm.getelementptr"(%80, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg1, %81) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %82 = "llvm.getelementptr"(%80, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg2, %82) <{alignment = 8 : i64, ordering = 0 : i64}> : (i16, !llvm.ptr) -> ()
    %83 = "llvm.getelementptr"(%80, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb23:  // pred: ^bb22
    %88 = "llvm.getelementptr"(%80, %0) <{elem_type = !llvm.struct<"struct.WhereOrCost", (i64, i16, i16)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
