"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %7 = "llvm.lshr"(%arg1, %0) : (i32, i32) -> i32
    ...
    %10 = "llvm.lshr"(%arg1, %2) : (i32, i32) -> i32
    %11 = "llvm.trunc"(%10) <{overflowFlags = 0 : i32}> : (i32) -> i8
    ...
    "llvm.store"(%11, %12) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %13 = "llvm.lshr"(%arg1, %4) : (i32, i32) -> i32
    %14 = "llvm.trunc"(%13) <{overflowFlags = 0 : i32}> : (i32) -> i8
    %15 = "llvm.getelementptr"(%arg0, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%14, %15) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %16 = "llvm.trunc"(%arg1) <{overflowFlags = 0 : i32}> : (i32) -> i8
    %17 = "llvm.getelementptr"(%arg0, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
