"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    %13 = "llvm.getelementptr"(%2, %1, %12) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
