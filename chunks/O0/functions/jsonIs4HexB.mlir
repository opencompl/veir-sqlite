"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %1 = "llvm.mlir.constant"() <{value = 117 : i32}> : () -> i32
  ...
  ^bb2:  // pred: ^bb0
    ...
    %11 = "llvm.call"(%10) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @jsonIs4Hex, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i32
  ...
  ^bb4:  // pred: ^bb2
    ...
    "llvm.br"(%5)[^bb5] : (i32) -> ()
  ^bb5(%13: i32):  // 3 preds: ^bb1, ^bb3, ^bb4
    "llvm.return"(%13) : (i32) -> ()
  }) : () -> ()
