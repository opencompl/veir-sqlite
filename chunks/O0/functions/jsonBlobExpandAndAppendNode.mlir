"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i8, %arg2: i64, %arg3: !llvm.ptr):
    ...
    %6 = "llvm.add"(%5, %arg2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %7 = "llvm.add"(%6, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %8 = "llvm.trunc"(%7) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %9 = "llvm.call"(%arg0, %8) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @jsonBlobExpand, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i32) -> i32
