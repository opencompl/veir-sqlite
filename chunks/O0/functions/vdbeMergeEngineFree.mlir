"builtin.module"() ({
  ...
  ^bb2(%5: i32):  // 2 preds: ^bb1, ^bb4
    %6 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.MergeEngine", (i32, ptr, ptr, ptr)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    %9 = "llvm.getelementptr"(%arg0, %1) <{elem_type = !llvm.struct<"struct.MergeEngine", (i32, ptr, ptr, ptr)>, noWrapFlags = 7 : i32, rawConstantIndices = array<i32: -2147483648, 3>}> : (!llvm.ptr, i32) -> !llvm.ptr
