"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    %0 = "llvm.mlir.constant"() <{value = 4096 : i32}> : () -> i32
    %1 = "llvm.mlir.constant"() <{value = 4062 : i64}> : () -> i64
    %2 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i64
    %3 = "llvm.mlir.constant"() <{value = 4096 : i64}> : () -> i64
    %4 = "llvm.add"(%arg0, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %5 = "llvm.zext"(%4) : (i32) -> i64
    %6 = "llvm.sub"(%5, %1) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %7 = "llvm.sub"(%6, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
