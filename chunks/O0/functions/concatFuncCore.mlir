"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], dso_local, frame_pointer = #llvm.framePointerKind<"non-leaf-no-reserve">, function_type = !llvm.func<void (ptr, i32, ptr, i32, ptr)>, linkage = #llvm.linkage<external>, no_inline, no_unwind, passthrough = ["ssp", ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "apple-m1"]], sym_name = "concatFuncCore", target_cpu = "apple-m1", target_features = #llvm.target_features<["+aes", "+altnzcv", "+ccdp", "+ccidx", "+ccpp", "+complxnum", "+crc", "+dit", "+dotprod", "+flagm", "+fp-armv8", "+fp16fml", "+fptoint", "+fullfp16", "+jsconv", "+lse", "+neon", "+pauth", "+perfmon", "+predres", "+ras", "+rcpc", "+rdm", "+sb", "+sha2", "+sha3", "+specrestrict", "+ssbs", "+v8.1a", "+v8.2a", "+v8.3a", "+v8.4a", "+v8a"]>, tune_cpu = "apple-m5", unnamed_addr = 0 : i64, uwtable_kind = #llvm.uwtableKind<sync>, visibility_ = 1 : i64}> ({
  ...
  ^bb1(%11: i32, %12: i64):  // 2 preds: ^bb0, ^bb3
    %13 = "llvm.icmp"(%11, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%13)[^bb2, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %14 = "llvm.sext"(%11) : (i32) -> i64
    %15 = "llvm.getelementptr"(%arg2, %14) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %16 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %17 = "llvm.call"(%16) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3_value_bytes, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i32
    %18 = "llvm.sext"(%17) : (i32) -> i64
    %19 = "llvm.add"(%12, %18) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // pred: ^bb2
    %20 = "llvm.add"(%11, %2) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%20, %19)[^bb1] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32, i64) -> ()
  ^bb4:  // pred: ^bb1
    %21 = "llvm.sub"(%arg1, %2) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %22 = "llvm.sext"(%21) : (i32) -> i64
    %23 = "llvm.sext"(%arg3) : (i32) -> i64
    %24 = "llvm.mul"(%22, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %25 = "llvm.add"(%12, %24) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %26 = "llvm.add"(%25, %3) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %27 = "llvm.call"(%26) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3_malloc64, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i64) -> !llvm.ptr
  ...
  ^bb7(%29: i32, %30: i32, %31: i64):  // 2 preds: ^bb6, ^bb16
    %32 = "llvm.icmp"(%30, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%32)[^bb8, ^bb17] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb8:  // pred: ^bb7
    ...
    %37 = "llvm.icmp"(%36, %8) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%37, %29, %31)[^bb9, ^bb15] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i32, i64) -> ()
  ^bb9:  // pred: ^bb8
    %38 = "llvm.sext"(%30) : (i32) -> i64
    %39 = "llvm.getelementptr"(%arg2, %38) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %40 = "llvm.load"(%39) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %41 = "llvm.call"(%40) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}], callee = @sqlite3_value_bytes, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i32
    ...
    "llvm.cond_br"(%46, %29, %31)[^bb10, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i32, i64) -> ()
  ^bb10:  // pred: ^bb9
    %47 = "llvm.icmp"(%29, %0) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%47, %31)[^bb11, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb11:  // pred: ^bb10
    %48 = "llvm.icmp"(%arg3, %0) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%48, %31)[^bb12, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb12:  // pred: ^bb11
    %49 = "llvm.getelementptr"(%27, %31) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %50 = "llvm.sext"(%arg3) : (i32) -> i64
    %51 = "llvm.getelementptr"(%27, %31) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %52 = "llvm.call_intrinsic"(%51, %9, %10, %9) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.objectsize.i64.p0", op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i1, i1, i1) -> i64
    %53 = "llvm.call"(%49, %arg4, %50, %52) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @__memcpy_chk, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.ptr, i64, i64) -> !llvm.ptr
    %54 = "llvm.sext"(%arg3) : (i32) -> i64
    %55 = "llvm.add"(%31, %54) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    "llvm.br"(%55)[^bb13] : (i64) -> ()
  ^bb13(%56: i64):  // 3 preds: ^bb10, ^bb11, ^bb12
    %57 = "llvm.getelementptr"(%27, %56) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %58 = "llvm.sext"(%41) : (i32) -> i64
    %59 = "llvm.getelementptr"(%27, %56) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %60 = "llvm.call_intrinsic"(%59, %9, %10, %9) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.objectsize.i64.p0", op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i1, i1, i1) -> i64
    %61 = "llvm.call"(%57, %45, %58, %60) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @__memcpy_chk, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.ptr, i64, i64) -> !llvm.ptr
    %62 = "llvm.sext"(%41) : (i32) -> i64
    %63 = "llvm.add"(%56, %62) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    "llvm.br"(%2, %63)[^bb14] : (i32, i64) -> ()
  ^bb14(%64: i32, %65: i64):  // 2 preds: ^bb9, ^bb13
    "llvm.br"(%64, %65)[^bb15] : (i32, i64) -> ()
  ^bb15(%66: i32, %67: i64):  // 2 preds: ^bb8, ^bb14
    "llvm.br"()[^bb16] : () -> ()
  ^bb16:  // pred: ^bb15
    %68 = "llvm.add"(%30, %2) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%66, %68, %67)[^bb7] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>}> : (i32, i32, i64) -> ()
  ^bb17:  // pred: ^bb7
    %69 = "llvm.getelementptr"(%27, %31) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%5, %69) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.call"(%arg0, %27, %31, %6, %7) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @sqlite3_result_text64, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr, i8) -> ()
    "llvm.br"()[^bb18] : () -> ()
