"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i16, %arg2: i16, %arg3: !llvm.ptr, %arg4: i32):
    ...
    %9 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %10 = "llvm.load"(%9) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %11 = "llvm.getelementptr"(%10, %1) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%11, %9) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %12 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %13 = "llvm.load"(%12) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %14 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb1
    %19 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    %20 = "llvm.load"(%19) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %21 = "llvm.getelementptr"(%20, %8) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    "llvm.br"()[^bb7] : () -> ()
  ^bb3:  // pred: ^bb1
    %22 = "llvm.getelementptr"(%arg0, %0) <{elem_type = !llvm.struct<"struct.yyParser", (ptr, ptr, ptr, ptr, array<50 x struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  ^bb6(%30: i16):  // 2 preds: ^bb4, ^bb5
    %31 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%30, %31) <{alignment = 8 : i64, ordering = 0 : i64}> : (i16, !llvm.ptr) -> ()
    %32 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 1>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%arg2, %32) <{alignment = 2 : i64, ordering = 0 : i64}> : (i16, !llvm.ptr) -> ()
    %33 = "llvm.getelementptr"(%24, %0) <{elem_type = !llvm.struct<"struct.yyStackEntry", (i16, i16, struct<"union.YYMINORTYPE", (struct<"struct.Token", (ptr, i32)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 2>}> : (!llvm.ptr, i32) -> !llvm.ptr
    ...
    "llvm.store"(%arg4, %34) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %35 = "llvm.getelementptr"(%33, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%7, %35) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 2 preds: ^bb2, ^bb6
    "llvm.return"() : () -> ()
  }) : () -> ()
